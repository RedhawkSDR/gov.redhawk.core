...
public class ScaSwitch< T1 > extends Switch<T1> {
	...
	protected T1 doSwitch(int classifierID, EObject theEObject) {
		...
		case ScaPackage.SCA_NEGOTIATED_CONNECTION: {
			ScaNegotiatedConnection scaNegotiatedConnection = (ScaNegotiatedConnection) theEObject;
			T1 result = caseScaNegotiatedConnection(scaNegotiatedConnection);
			if (result == null)
				result = caseScaConnection(scaNegotiatedConnection);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Negotiated Connection</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * 
	 ...
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Negotiated Connection</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T1 caseScaNegotiatedConnection(ScaNegotiatedConnection object) {
		return null;
	}
