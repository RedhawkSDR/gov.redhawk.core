	...
	protected T1 doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ScaPackage.CORBA_OBJ_WRAPPER: {
				...
				if (result == null) result = caseDataProviderObject(corbaObjWrapper);
				if (result == null) result = caseIStatusProvider(corbaObjWrapper);
				if (result == null) result = caseIDisposable(corbaObjWrapper);
				if (result == null) result = caseIRefreshable(corbaObjWrapper);
			...
			case ScaPackage.DATA_PROVIDER_OBJECT: {
				...
				if (result == null) result = caseIStatusProvider(dataProviderObject);
				if (result == null) result = caseIDisposable(dataProviderObject);
				if (result == null) result = caseIRefreshable(dataProviderObject);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ScaPackage.PROFILE_OBJECT_WRAPPER: {
				...
				if (result == null) result = caseIStatusProvider(profileObjectWrapper);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ScaPackage.SCA_ABSTRACT_COMPONENT: {
				...
				if (result == null) result = caseScaPropertyContainer(scaAbstractComponent);
				if (result == null) result = caseResourceOperations(scaAbstractComponent);
				if (result == null) result = caseScaPortContainer(scaAbstractComponent);
				if (result == null) result = caseCorbaObjWrapper(scaAbstractComponent);
				if (result == null) result = caseProfileObjectWrapper(scaAbstractComponent);
				if (result == null) result = casePropertySetOperations(scaAbstractComponent);
				if (result == null) result = caseLifeCycleOperations(scaAbstractComponent);
				if (result == null) result = caseTestableObjectOperations(scaAbstractComponent);
				if (result == null) result = casePortSupplierOperations(scaAbstractComponent);
				if (result == null) result = caseDataProviderObject(scaAbstractComponent);
				if (result == null) result = caseIStatusProvider(scaAbstractComponent);
				if (result == null) result = caseIDisposable(scaAbstractComponent);
				if (result == null) result = caseIRefreshable(scaAbstractComponent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ScaPackage.SCA_PROPERTY_CONTAINER: {
				...
				if (result == null) result = caseCorbaObjWrapper(scaPropertyContainer);
				if (result == null) result = caseProfileObjectWrapper(scaPropertyContainer);
				if (result == null) result = casePropertySetOperations(scaPropertyContainer);
				if (result == null) result = caseDataProviderObject(scaPropertyContainer);
				if (result == null) result = caseIStatusProvider(scaPropertyContainer);
				if (result == null) result = caseIDisposable(scaPropertyContainer);
				if (result == null) result = caseIRefreshable(scaPropertyContainer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ScaPackage.SCA_PORT_CONTAINER: {
				...
				if (result == null) result = caseIRefreshable(scaPortContainer);
				if (result == null) result = caseIStatusProvider(scaPortContainer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ScaPackage.SCA_ABSTRACT_PROPERTY: {
				...
				if (result == null) result = caseIStatusProvider(scaAbstractProperty);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ScaPackage.SCA_COMPONENT: {
				...
				if (result == null) result = caseScaAbstractComponent(scaComponent);
				if (result == null) result = caseScaPropertyContainer(scaComponent);
				if (result == null) result = caseResourceOperations(scaComponent);
				if (result == null) result = caseScaPortContainer(scaComponent);
				if (result == null) result = caseCorbaObjWrapper(scaComponent);
				if (result == null) result = caseProfileObjectWrapper(scaComponent);
				if (result == null) result = casePropertySetOperations(scaComponent);
				if (result == null) result = caseLifeCycleOperations(scaComponent);
				if (result == null) result = caseTestableObjectOperations(scaComponent);
				if (result == null) result = casePortSupplierOperations(scaComponent);
				if (result == null) result = caseDataProviderObject(scaComponent);
				if (result == null) result = caseIStatusProvider(scaComponent);
				if (result == null) result = caseIDisposable(scaComponent);
				if (result == null) result = caseIRefreshable(scaComponent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ScaPackage.SCA_DEVICE: {
				...
				if (result == null) result = caseScaAbstractComponent(scaDevice);
				if (result == null) result = caseDeviceOperations(scaDevice);
				if (result == null) result = caseScaPropertyContainer(scaDevice);
				if (result == null) result = caseResourceOperations(scaDevice);
				if (result == null) result = caseScaPortContainer(scaDevice);
				if (result == null) result = caseCorbaObjWrapper(scaDevice);
				if (result == null) result = caseProfileObjectWrapper(scaDevice);
				if (result == null) result = casePropertySetOperations(scaDevice);
				if (result == null) result = caseLifeCycleOperations(scaDevice);
				if (result == null) result = caseTestableObjectOperations(scaDevice);
				if (result == null) result = casePortSupplierOperations(scaDevice);
				if (result == null) result = caseDataProviderObject(scaDevice);
				if (result == null) result = caseIStatusProvider(scaDevice);
				if (result == null) result = caseIDisposable(scaDevice);
				if (result == null) result = caseIRefreshable(scaDevice);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ScaPackage.SCA_DEVICE_MANAGER: {
				...
				if (result == null) result = caseScaPropertyContainer(scaDeviceManager);
				if (result == null) result = caseDeviceManagerOperations(scaDeviceManager);
				if (result == null) result = caseScaPortContainer(scaDeviceManager);
				if (result == null) result = caseCorbaObjWrapper(scaDeviceManager);
				if (result == null) result = caseProfileObjectWrapper(scaDeviceManager);
				if (result == null) result = casePropertySetOperations(scaDeviceManager);
				if (result == null) result = casePortSupplierOperations(scaDeviceManager);
				if (result == null) result = caseDataProviderObject(scaDeviceManager);
				if (result == null) result = caseIStatusProvider(scaDeviceManager);
				if (result == null) result = caseIDisposable(scaDeviceManager);
				if (result == null) result = caseIRefreshable(scaDeviceManager);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ScaPackage.SCA_SERVICE: {
				...
				if (result == null) result = caseScaPropertyContainer(scaService);
				if (result == null) result = caseScaPortContainer(scaService);
				if (result == null) result = caseCorbaObjWrapper(scaService);
				if (result == null) result = caseProfileObjectWrapper(scaService);
				if (result == null) result = casePropertySetOperations(scaService);
				if (result == null) result = caseDataProviderObject(scaService);
				if (result == null) result = caseIStatusProvider(scaService);
				if (result == null) result = caseIDisposable(scaService);
				if (result == null) result = caseIRefreshable(scaService);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ScaPackage.SCA_DEVICE_MANAGER_FILE_SYSTEM: {
				...
				if (result == null) result = caseScaFileSystem(scaDeviceManagerFileSystem);
				if (result == null) result = caseCorbaObjWrapper(scaDeviceManagerFileSystem);
				if (result == null) result = caseFileSystemOperations(scaDeviceManagerFileSystem);
				if (result == null) result = caseScaFileStore(scaDeviceManagerFileSystem);
				if (result == null) result = caseDataProviderObject(scaDeviceManagerFileSystem);
				if (result == null) result = caseIStatusProvider(scaDeviceManagerFileSystem);
				if (result == null) result = caseIDisposable(scaDeviceManagerFileSystem);
				if (result == null) result = caseIRefreshable(scaDeviceManagerFileSystem);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ScaPackage.SCA_DOMAIN_MANAGER: {
				...
				if (result == null) result = caseScaPropertyContainer(scaDomainManager);
				if (result == null) result = caseDomainManagerOperations(scaDomainManager);
				if (result == null) result = caseCorbaObjWrapper(scaDomainManager);
				if (result == null) result = caseProfileObjectWrapper(scaDomainManager);
				if (result == null) result = casePropertySetOperations(scaDomainManager);
				if (result == null) result = caseDataProviderObject(scaDomainManager);
				if (result == null) result = caseIStatusProvider(scaDomainManager);
				if (result == null) result = caseIDisposable(scaDomainManager);
				if (result == null) result = caseIRefreshable(scaDomainManager);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ScaPackage.SCA_DOMAIN_MANAGER_FILE_SYSTEM: {
				...
				if (result == null) result = caseScaFileManager(scaDomainManagerFileSystem);
				if (result == null) result = caseScaFileSystem(scaDomainManagerFileSystem);
				if (result == null) result = caseFileManagerOperations(scaDomainManagerFileSystem);
				if (result == null) result = caseCorbaObjWrapper(scaDomainManagerFileSystem);
				if (result == null) result = caseFileSystemOperations(scaDomainManagerFileSystem);
				if (result == null) result = caseScaFileStore(scaDomainManagerFileSystem);
				if (result == null) result = caseDataProviderObject(scaDomainManagerFileSystem);
				if (result == null) result = caseIStatusProvider(scaDomainManagerFileSystem);
				if (result == null) result = caseIDisposable(scaDomainManagerFileSystem);
				if (result == null) result = caseIRefreshable(scaDomainManagerFileSystem);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ScaPackage.SCA_DOMAIN_MANAGER_REGISTRY: {
				...
				if (result == null) result = caseIDisposable(scaDomainManagerRegistry);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ScaPackage.SCA_EXECUTABLE_DEVICE: {
				...
				if (result == null) result = caseScaLoadableDevice(scaExecutableDevice);
				if (result == null) result = caseExecutableDeviceOperations(scaExecutableDevice);
				if (result == null) result = caseScaDevice(scaExecutableDevice);
				if (result == null) result = caseLoadableDeviceOperations(scaExecutableDevice);
				if (result == null) result = caseScaAbstractComponent(scaExecutableDevice);
				if (result == null) result = caseDeviceOperations(scaExecutableDevice);
				if (result == null) result = caseScaPropertyContainer(scaExecutableDevice);
				if (result == null) result = caseResourceOperations(scaExecutableDevice);
				if (result == null) result = caseScaPortContainer(scaExecutableDevice);
				if (result == null) result = caseCorbaObjWrapper(scaExecutableDevice);
				if (result == null) result = caseProfileObjectWrapper(scaExecutableDevice);
				if (result == null) result = casePropertySetOperations(scaExecutableDevice);
				if (result == null) result = caseLifeCycleOperations(scaExecutableDevice);
				if (result == null) result = caseTestableObjectOperations(scaExecutableDevice);
				if (result == null) result = casePortSupplierOperations(scaExecutableDevice);
				if (result == null) result = caseDataProviderObject(scaExecutableDevice);
				if (result == null) result = caseIStatusProvider(scaExecutableDevice);
				if (result == null) result = caseIDisposable(scaExecutableDevice);
				if (result == null) result = caseIRefreshable(scaExecutableDevice);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ScaPackage.SCA_FILE_MANAGER: {
				...
				if (result == null) result = caseScaFileSystem(scaFileManager);
				if (result == null) result = caseFileManagerOperations(scaFileManager);
				if (result == null) result = caseCorbaObjWrapper(scaFileManager);
				if (result == null) result = caseFileSystemOperations(scaFileManager);
				if (result == null) result = caseScaFileStore(scaFileManager);
				if (result == null) result = caseDataProviderObject(scaFileManager);
				if (result == null) result = caseIStatusProvider(scaFileManager);
				if (result == null) result = caseIDisposable(scaFileManager);
				if (result == null) result = caseIRefreshable(scaFileManager);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ScaPackage.SCA_FILE_STORE: {
				...
				if (result == null) result = caseIStatusProvider(scaFileStore);
				if (result == null) result = caseIRefreshable(scaFileStore);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ScaPackage.SCA_FILE_SYSTEM: {
				...
				if (result == null) result = caseCorbaObjWrapper(scaFileSystem);
				if (result == null) result = caseFileSystemOperations(scaFileSystem);
				if (result == null) result = caseScaFileStore(scaFileSystem);
				if (result == null) result = caseDataProviderObject(scaFileSystem);
				if (result == null) result = caseIStatusProvider(scaFileSystem);
				if (result == null) result = caseIDisposable(scaFileSystem);
				if (result == null) result = caseIRefreshable(scaFileSystem);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ScaPackage.SCA_LOADABLE_DEVICE: {
				...
				if (result == null) result = caseScaDevice(scaLoadableDevice);
				if (result == null) result = caseLoadableDeviceOperations(scaLoadableDevice);
				if (result == null) result = caseScaAbstractComponent(scaLoadableDevice);
				if (result == null) result = caseDeviceOperations(scaLoadableDevice);
				if (result == null) result = caseScaPropertyContainer(scaLoadableDevice);
				if (result == null) result = caseResourceOperations(scaLoadableDevice);
				if (result == null) result = caseScaPortContainer(scaLoadableDevice);
				if (result == null) result = caseCorbaObjWrapper(scaLoadableDevice);
				if (result == null) result = caseProfileObjectWrapper(scaLoadableDevice);
				if (result == null) result = casePropertySetOperations(scaLoadableDevice);
				if (result == null) result = caseLifeCycleOperations(scaLoadableDevice);
				if (result == null) result = caseTestableObjectOperations(scaLoadableDevice);
				if (result == null) result = casePortSupplierOperations(scaLoadableDevice);
				if (result == null) result = caseDataProviderObject(scaLoadableDevice);
				if (result == null) result = caseIStatusProvider(scaLoadableDevice);
				if (result == null) result = caseIDisposable(scaLoadableDevice);
				if (result == null) result = caseIRefreshable(scaLoadableDevice);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ScaPackage.SCA_PORT: {
				...
				if (result == null) result = caseCorbaObjWrapper(scaPort);
				if (result == null) result = caseDataProviderObject(scaPort);
				if (result == null) result = caseIStatusProvider(scaPort);
				if (result == null) result = caseIDisposable(scaPort);
				if (result == null) result = caseIRefreshable(scaPort);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ScaPackage.SCA_PROVIDES_PORT: {
				...
				if (result == null) result = caseScaPort(scaProvidesPort);
				if (result == null) result = caseCorbaObjWrapper(scaProvidesPort);
				if (result == null) result = caseDataProviderObject(scaProvidesPort);
				if (result == null) result = caseIStatusProvider(scaProvidesPort);
				if (result == null) result = caseIDisposable(scaProvidesPort);
				if (result == null) result = caseIRefreshable(scaProvidesPort);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ScaPackage.SCA_SIMPLE_PROPERTY: {
				...
				if (result == null) result = caseScaAbstractProperty(scaSimpleProperty);
				if (result == null) result = caseIStatusProvider(scaSimpleProperty);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ScaPackage.SCA_SIMPLE_SEQUENCE_PROPERTY: {
				...
				if (result == null) result = caseScaAbstractProperty(scaSimpleSequenceProperty);
				if (result == null) result = caseIStatusProvider(scaSimpleSequenceProperty);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ScaPackage.SCA_STRUCT_PROPERTY: {
				...
				if (result == null) result = caseScaAbstractProperty(scaStructProperty);
				if (result == null) result = casePropertySetOperations(scaStructProperty);
				if (result == null) result = caseIStatusProvider(scaStructProperty);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ScaPackage.SCA_USES_PORT: {
				...
				if (result == null) result = caseScaPort(scaUsesPort);
				if (result == null) result = casePortOperations(scaUsesPort);
				if (result == null) result = caseCorbaObjWrapper(scaUsesPort);
				if (result == null) result = caseDataProviderObject(scaUsesPort);
				if (result == null) result = caseIStatusProvider(scaUsesPort);
				if (result == null) result = caseIDisposable(scaUsesPort);
				if (result == null) result = caseIRefreshable(scaUsesPort);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ScaPackage.SCA_WAVEFORM: {
				...
				if (result == null) result = caseScaPropertyContainer(scaWaveform);
				if (result == null) result = caseApplicationOperations(scaWaveform);
				if (result == null) result = caseScaPortContainer(scaWaveform);
				if (result == null) result = caseCorbaObjWrapper(scaWaveform);
				if (result == null) result = caseProfileObjectWrapper(scaWaveform);
				if (result == null) result = caseResourceOperations(scaWaveform);
				if (result == null) result = caseDataProviderObject(scaWaveform);
				if (result == null) result = casePropertySetOperations(scaWaveform);
				if (result == null) result = caseLifeCycleOperations(scaWaveform);
				if (result == null) result = caseTestableObjectOperations(scaWaveform);
				if (result == null) result = casePortSupplierOperations(scaWaveform);
				if (result == null) result = caseIStatusProvider(scaWaveform);
				if (result == null) result = caseIDisposable(scaWaveform);
				if (result == null) result = caseIRefreshable(scaWaveform);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ScaPackage.SCA_WAVEFORM_FACTORY: {
				...
				if (result == null) result = caseCorbaObjWrapper(scaWaveformFactory);
				if (result == null) result = caseApplicationFactoryOperations(scaWaveformFactory);
				if (result == null) result = caseProfileObjectWrapper(scaWaveformFactory);
				if (result == null) result = caseDataProviderObject(scaWaveformFactory);
				if (result == null) result = caseIStatusProvider(scaWaveformFactory);
				if (result == null) result = caseIDisposable(scaWaveformFactory);
				if (result == null) result = caseIRefreshable(scaWaveformFactory);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ScaPackage.SCA_STRUCT_SEQUENCE_PROPERTY: {
				...
				if (result == null) result = caseScaAbstractProperty(scaStructSequenceProperty);
				if (result == null) result = casePropertySetOperations(scaStructSequenceProperty);
				if (result == null) result = caseIStatusProvider(scaStructSequenceProperty);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
