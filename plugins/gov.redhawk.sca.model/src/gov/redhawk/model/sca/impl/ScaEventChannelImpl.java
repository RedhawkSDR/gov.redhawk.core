...
public class ScaEventChannelImpl extends CorbaObjWrapperImpl<EventChannel> implements ScaEventChannel {
	...
	protected EClass eStaticClass() {
		return ScaPackage.Literals.SCA_EVENT_CHANNEL;
	}
	 ...
	 */
	@Override
	public void setObj(EventChannel newObj) {
		super.setObj(newObj);
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ScaPackage.SCA_EVENT_CHANNEL__NAME, oldName, name));
	}
	...
	@Override
	protected EventChannel narrow(org.omg.CORBA.Object obj) {
