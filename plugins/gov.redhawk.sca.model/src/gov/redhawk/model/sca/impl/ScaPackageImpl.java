...
public class ScaPackageImpl extends EPackageImpl implements ScaPackage {
	...
	public void createPackageContents() {
		...
		createEAttribute(scaDeviceEClass, SCA_DEVICE__PROFILE);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getCorbaObjWrapper_Ior(), theEcorePackage.getEString(), "ior", null, 0, 1, CorbaObjWrapper.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		g1 = createEGenericType(corbaObjWrapperEClass_T);
		initEAttribute(getCorbaObjWrapper_Obj(), g1, "obj", null, 0, 1, CorbaObjWrapper.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCorbaObjWrapper_CorbaObj(), this.getObject(), "corbaObj", null, 0, 1, CorbaObjWrapper.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getDataProviderObject_DataProviders(), this.getIScaDataProvider(), "dataProviders", null, 0, -1, DataProviderObject.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDataProviderObject_DataProvidersEnabled(), theEcorePackage.getEBoolean(), "dataProvidersEnabled", "true", 0, 1, DataProviderObject.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getIDisposable_Disposed(), theEcorePackage.getEBoolean(), "disposed", null, 0, 1, IDisposable.class, IS_TRANSIENT, !IS_VOLATILE, !IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getProfileObjectWrapper_ProfileURI(), theSpdPackage.getURI(), "profileURI", null, 0, 1, ProfileObjectWrapper.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		g1 = createEGenericType(profileObjectWrapperEClass_O);
		initEReference(getProfileObjectWrapper_ProfileObj(), g1, null, "profileObj", null, 0, 1, ProfileObjectWrapper.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getProfileObjectWrapper_RootFileStore(), this.getIFileStore(), "rootFileStore", null, 0, 1, ProfileObjectWrapper.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		...
		initEReference(getProperties_Property(), this.getStringToStringMap(), null, "property", null, 0, -1, Properties.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getScaAbstractComponent_Identifier(), theEcorePackage.getEString(), "identifier", null, 0, 1, ScaAbstractComponent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getScaAbstractComponent_Started(), theXMLTypePackage.getBooleanObject(), "started", null, 0, 1, ScaAbstractComponent.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		g1.getETypeArguments().add(g2);
		initEReference(getScaPropertyContainer_Properties(), g1, null, "properties", null, 0, -1, ScaPropertyContainer.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		g2 = createEGenericType();
		g1.getETypeArguments().add(g2);
		initEReference(getScaPortContainer_Ports(), g1, this.getScaPort_PortContainer(), "ports", null, 0, -1, ScaPortContainer.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getScaAbstractProperty_Definition(), g1, null, "definition", null, 0, 1, ScaAbstractProperty.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getScaAbstractProperty_Description(), theEcorePackage.getEString(), "description", null, 0, 1, ScaAbstractProperty.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getScaAbstractProperty_Id(), theEcorePackage.getEString(), "id", null, 0, 1, ScaAbstractProperty.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getScaAbstractProperty_Mode(), thePrfPackage.getAccessType(), "mode", null, 0, 1, ScaAbstractProperty.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getScaAbstractProperty_Name(), theEcorePackage.getEString(), "name", null, 0, 1, ScaAbstractProperty.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getScaAbstractProperty_IgnoreRemoteSet(), theEcorePackage.getEBoolean(), "ignoreRemoteSet", null, 0, 1, ScaAbstractProperty.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		...
		initEReference(getScaComponent_ComponentInstantiation(), theSadPackage.getSadComponentInstantiation(), null, "componentInstantiation", null, 1, 1, ScaComponent.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		g1 = createEGenericType(this.getScaDevice());
		g2 = createEGenericType();
		g1.getETypeArguments().add(g2);
		initEReference(getScaComponent_Devices(), g1, null, "devices", null, 0, -1, ScaComponent.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getScaComponent_InstantiationIdentifier(), theEcorePackage.getEString(), "instantiationIdentifier", null, 0, 1, ScaComponent.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEReference(getScaComponent_Waveform(), this.getScaWaveform(), this.getScaWaveform_Components(), "waveform", null, 0, 1, ScaComponent.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getScaComponent_Name(), theEcorePackage.getEString(), "name", null, 0, 1, ScaComponent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		g2 = createEGenericType();
		g1.getETypeArguments().add(g2);
		initEReference(getScaDevice_ChildDevices(), g1, this.getScaDevice_ParentDevice(), "childDevices", null, 0, -1, ScaDevice.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getScaDevice_AdminState(), this.getAdminType(), "adminState", null, 0, 1, ScaDevice.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getScaDevice_Label(), theXMLTypePackage.getString(), "label", null, 0, 1, ScaDevice.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getScaDevice_OperationalState(), this.getOperationalType(), "operationalState", null, 0, 1, ScaDevice.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getScaDevice_UsageState(), this.getUsageType(), "usageState", null, 0, 1, ScaDevice.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		g1 = createEGenericType(this.getScaDevice());
		g2 = createEGenericType();
		g1.getETypeArguments().add(g2);
		initEReference(getScaDevice_ParentDevice(), g1, this.getScaDevice_ChildDevices(), "parentDevice", null, 0, 1, ScaDevice.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getScaDevice_DevMgr(), this.getScaDeviceManager(), null, "devMgr", null, 0, 1, ScaDevice.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getScaDevice_Profile(), theEcorePackage.getEString(), "profile", null, 0, 1, ScaDevice.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		op = addEOperation(scaDeviceEClass, theEcorePackage.getEString(), "fetchProfile", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getIProgressMonitor(), "monitor", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEAttribute(getScaDeviceManager_Devices(), theEcorePackage.getEFeatureMapEntry(), "devices", null, 0, -1, ScaDeviceManager.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		g1 = createEGenericType(this.getScaDevice());
		g2 = createEGenericType();
		g1.getETypeArguments().add(g2);
		initEReference(getScaDeviceManager_RootDevices(), g1, null, "rootDevices", null, 0, -1, ScaDeviceManager.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		g1 = createEGenericType(this.getScaDevice());
		g2 = createEGenericType();
		g1.getETypeArguments().add(g2);
		initEReference(getScaDeviceManager_ChildDevices(), g1, null, "childDevices", null, 0, -1, ScaDeviceManager.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		g1 = createEGenericType(this.getScaDevice());
		g2 = createEGenericType();
		g1.getETypeArguments().add(g2);
		initEReference(getScaDeviceManager_AllDevices(), g1, null, "allDevices", null, 0, -1, ScaDeviceManager.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEReference(getScaDeviceManager_FileSystem(), this.getScaDeviceManagerFileSystem(), this.getScaDeviceManagerFileSystem_DeviceManager(), "fileSystem", null, 0, 1, ScaDeviceManager.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getScaDocumentRoot_Mixed(), ecorePackage.getEFeatureMapEntry(), "mixed", null, 0, -1, null, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getScaDocumentRoot_XMLNSPrefixMap(), ecorePackage.getEStringToStringMapEntry(), null, "xMLNSPrefixMap", null, 0, -1, null, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getScaDocumentRoot_XSISchemaLocation(), ecorePackage.getEStringToStringMapEntry(), null, "xSISchemaLocation", null, 0, -1, null, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getScaDocumentRoot_DomainManagerRegistry(), this.getScaDomainManagerRegistry(), null, "domainManagerRegistry", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		...
		initEReference(getScaDomainManager_WaveformFactories(), this.getScaWaveformFactory(), this.getScaWaveformFactory_DomMgr(), "waveformFactories", null, 0, -1, ScaDomainManager.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getScaDomainManager_Waveforms(), this.getScaWaveform(), this.getScaWaveform_DomMgr(), "waveforms", null, 0, -1, ScaDomainManager.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getScaDomainManager_DeviceManagers(), this.getScaDeviceManager(), this.getScaDeviceManager_DomMgr(), "deviceManagers", null, 0, -1, ScaDomainManager.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getScaDomainManager_FileManager(), this.getScaDomainManagerFileSystem(), this.getScaDomainManagerFileSystem_DomMgr(), "fileManager", null, 0, 1, ScaDomainManager.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getScaDomainManager_ConnectionPropertiesContainer(), this.getProperties(), null, "connectionPropertiesContainer", null, 1, 1, ScaDomainManager.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getScaDomainManager_ConnectionProperties(), this.getStringToStringMap(), null, "connectionProperties", null, 0, -1, ScaDomainManager.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getScaDomainManager_AutoConnect(), theEcorePackage.getEBoolean(), "autoConnect", null, 0, 1, ScaDomainManager.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getScaDomainManager_Connected(), theEcorePackage.getEBoolean(), "connected", null, 1, 1, ScaDomainManager.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getScaDomainManager_Identifier(), theEcorePackage.getEString(), "identifier", null, 0, 1, ScaDomainManager.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getScaDomainManager_Name(), theEcorePackage.getEString(), "name", null, 1, 1, ScaDomainManager.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getScaDomainManager_RootContext(), theCfPackage.getNamingContextExt(), "rootContext", null, 1, 1, ScaDomainManager.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getScaDomainManager_State(), this.getDomainConnectionState(), "state", null, 1, 1, ScaDomainManager.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getScaDomainManager_Profile(), theEcorePackage.getEString(), "profile", null, 0, 1, ScaDomainManager.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(scaDomainManagerFileSystemEClass, ScaDomainManagerFileSystem.class, "ScaDomainManagerFileSystem", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getScaDomainManagerFileSystem_DomMgr(), this.getScaDomainManager(), this.getScaDomainManager_FileManager(), "domMgr", null, 0, 1, ScaDomainManagerFileSystem.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(scaDomainManagerRegistryEClass, ScaDomainManagerRegistry.class, "ScaDomainManagerRegistry", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getScaDomainManagerRegistry_Domains(), this.getScaDomainManager(), null, "domains", null, 0, -1, ScaDomainManagerRegistry.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getScaFileStore_FileStore(), this.getIFileStore(), "fileStore", null, 0, 1, ScaFileStore.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getScaFileStore_Children(), this.getScaFileStore(), null, "children", null, 0, -1, ScaFileStore.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getScaFileStore_ImageDesc(), theEcorePackage.getEJavaObject(), "imageDesc", null, 0, 1, ScaFileStore.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getScaFileStore_Directory(), theEcorePackage.getEBoolean(), "directory", null, 0, 1, ScaFileStore.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getScaFileStore_Name(), theEcorePackage.getEString(), "name", null, 0, 1, ScaFileStore.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getScaFileSystem_FileSystemURI(), this.getURI(), "fileSystemURI", "", 1, 1, ScaFileSystem.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		...
		initEReference(getScaPort_PortContainer(), this.getScaPortContainer(), this.getScaPortContainer_Ports(), "portContainer", null, 1, 1, ScaPort.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getScaSimpleProperty_Value(), theEcorePackage.getEJavaObject(), "value", null, 0, 1, ScaSimpleProperty.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(scaSimpleSequencePropertyEClass, ScaSimpleSequenceProperty.class, "ScaSimpleSequenceProperty", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getScaSimpleSequenceProperty_Values(), theEcorePackage.getEJavaObject(), "values", null, 0, -1, ScaSimpleSequenceProperty.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getScaStructProperty_Simples(), this.getScaSimpleProperty(), null, "simples", null, 0, -1, ScaStructProperty.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getScaUsesPort_Connections(), this.getScaConnection(), this.getScaConnection_Port(), "connections", null, 0, -1, ScaUsesPort.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getScaConnection_Data(), theExtendedPackage.getUsesConnection(), "data", null, 0, 1, ScaConnection.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getScaConnection_Id(), theEcorePackage.getEString(), "id", null, 0, 1, ScaConnection.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEReference(getScaConnection_Port(), this.getScaUsesPort(), this.getScaUsesPort_Connections(), "port", null, 1, 1, ScaConnection.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(scaWaveformEClass, ScaWaveform.class, "ScaWaveform", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getScaWaveform_Components(), this.getScaComponent(), this.getScaComponent_Waveform(), "components", null, 0, -1, ScaWaveform.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getScaWaveform_Components().getEKeys().add(this.getScaAbstractComponent_Identifier());
		initEReference(getScaWaveform_AssemblyController(), this.getScaComponent(), null, "assemblyController", null, 0, 1, ScaWaveform.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEReference(getScaWaveform_DomMgr(), this.getScaDomainManager(), this.getScaDomainManager_Waveforms(), "domMgr", null, 0, 1, ScaWaveform.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getScaWaveform_Identifier(), theEcorePackage.getEString(), "identifier", null, 0, 1, ScaWaveform.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getScaWaveform_Name(), theEcorePackage.getEString(), "name", null, 0, 1, ScaWaveform.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getScaWaveform_Started(), theXMLTypePackage.getBooleanObject(), "started", null, 0, 1, ScaWaveform.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getScaWaveform_Profile(), theEcorePackage.getEString(), "profile", null, 0, 1, ScaWaveform.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getScaWaveformFactory_DomMgr(), this.getScaDomainManager(), this.getScaDomainManager_WaveformFactories(), "domMgr", null, 1, 1, ScaWaveformFactory.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getScaWaveformFactory_Identifier(), theEcorePackage.getEString(), "identifier", null, 0, 1, ScaWaveformFactory.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getScaWaveformFactory_Name(), theEcorePackage.getEString(), "name", null, 0, 1, ScaWaveformFactory.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getScaWaveformFactory_Profile(), theEcorePackage.getEString(), "profile", null, 0, 1, ScaWaveformFactory.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getStringToStringMap_Key(), theEcorePackage.getEString(), "key", null, 1, 1, Map.Entry.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getStringToStringMap_Value(), theEcorePackage.getEString(), "value", null, 1, 1, Map.Entry.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(scaStructSequencePropertyEClass, ScaStructSequenceProperty.class, "ScaStructSequenceProperty", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getScaStructSequenceProperty_Structs(), this.getScaStructProperty(), null, "structs", null, 0, -1, ScaStructSequenceProperty.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getIStatusProvider_Status(), this.getIStatus(), "status", null, 0, 1, IStatusProvider.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		...
		initEDataType(domainConnectionExceptionEDataType, DomainConnectionException.class, "DomainConnectionException", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
		initEDataType(domainConnectionStateObjectEDataType, DomainConnectionState.class, "DomainConnectionStateObject", IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
		...
		initEDataType(iScaDataProviderServiceEDataType, IScaDataProviderService.class, "IScaDataProviderService", !IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
	...
	protected void createExtendedMetaDataAnnotations() {
		...
		addAnnotation
		  (adminTypeEDataType, 
		   ...
		   new String[] {
			 "name", "AdminType",
			 "enumeration", "LOCKED SHUTTING%20DOWN UNLOCKED"
		   });		
		addAnnotation
		  (corbaObjWrapperEClass, 
		   source, 
		   new String[] {
			 "name", "CorbaObjWrapper",
			 "kind", "empty"
		   });		
		addAnnotation
		  (getCorbaObjWrapper_Ior(), 
		   source, 
		   new String[] {
			 "kind", "attribute",
			 "name", "ior"
		...
		addAnnotation
		  (dataProviderObjectEClass, 
		   source, 
		   new String[] {
			 "name", "DataProviderObject",
			 "kind", "empty"
		   });		
		addAnnotation
		  (getDataProviderObject_DataProviders(), 
		   source, 
		   new String[] {
			 "kind", "attribute",
			 "name", "dataProviders"
		...
		addAnnotation
		  (domainConnectionStateEEnum, 
		   source, 
		   new String[] {
			 "name", "DomainConnectionState"
		   });		
		addAnnotation
		  (domainConnectionStateObjectEDataType, 
		   source, 
		   new String[] {
			 "name", "DomainConnectionState:Object",
			 "baseType", "DomainConnectionState"
		   });		
		addAnnotation
		  (iDisposableEClass, 
		   source, 
		...
		addAnnotation
		  (iProgressMonitorEDataType, 
		   source, 
		   new String[] {
			 "name", "IProgressMonitor"
		   });		
		addAnnotation
		  (iScaDataProviderEDataType, 
		   source, 
		   new String[] {
			 "name", "dataProvider"
		   });		
		addAnnotation
		  (iScaDataProviderServiceEDataType, 
		   source, 
		   new String[] {
		...
		addAnnotation
		  (objectArrayEDataType, 
		   source, 
		   new String[] {
			 "name", "ObjectArray"
		   });		
		addAnnotation
		  (operationalTypeEDataType, 
		   source, 
		   new String[] {
		...
		addAnnotation
		  (profileObjectWrapperEClass, 
		   source, 
		   new String[] {
			 "name", "ProfileObjectWrapper",
			 "kind", "empty"
		   });		
		addAnnotation
		  (getProfileObjectWrapper_ProfileURI(), 
		   source, 
		   new String[] {
			 "kind", "attribute",
			 "name", "profile"
		...
		addAnnotation
		  (getProfileObjectWrapper_ProfileObj(), 
		   source, 
		   new String[] {
			 "kind", "attribute",
			 "name", "profileObj"
		...
		addAnnotation
		  (refreshDepthObjectEDataType, 
		   source, 
		   new String[] {
			 "name", "RefreshDepth:Object",
			 "baseType", "RefreshDepth"
		   });		
		addAnnotation
		  (scaAbstractComponentEClass, 
		   source, 
		   new String[] {
			 "name", "ScaAbstractComponent",
			 "kind", "elementOnly"
		   });		
		addAnnotation
		  (getScaAbstractComponent_Identifier(), 
		   source, 
		   new String[] {
			 "kind", "attribute",
			 "name", "identifier"
		...
		addAnnotation
		  (scaPropertyContainerEClass, 
		   source, 
		   new String[] {
			 "name", "ScaPropertyContainer",
			 "kind", "elementOnly"
		   });		
		addAnnotation
		  (getScaPropertyContainer_Properties(), 
		   source, 
		   new String[] {
			 "kind", "element",
			 "name", "properties"
		...
		addAnnotation
		  (getScaAbstractProperty_Definition(), 
		   source, 
		   new String[] {
			 "kind", "attribute",
			 "name", "definition"
		...
		addAnnotation
		  (getScaAbstractProperty_Description(), 
		   source, 
		   new String[] {
			 "kind", "attribute",
			 "name", "description"
		...
		addAnnotation
		  (getScaComponent_ComponentInstantiation(), 
		   source, 
		   new String[] {
			 "kind", "attribute",
		...
		addAnnotation
		  (getScaComponent_InstantiationIdentifier(), 
		   source, 
		   new String[] {
			 "kind", "attribute",
		...
		addAnnotation
		  (scaDeviceManagerEClass, 
		   source, 
		   new String[] {
			 "name", "ScaDeviceManager",
			 "kind", "elementOnly"
		   });		
		addAnnotation
		  (getScaDeviceManager_Devices(), 
		   source, 
		   new String[] {
			 "kind", "group",
			 "name", "devices:1"
		...
		addAnnotation
		  (getScaDeviceManager_RootDevices(), 
		   source, 
		   new String[] {
			 "group", "#devices:1"
		   });		
		addAnnotation
		  (getScaDeviceManager_ChildDevices(), 
		   source, 
		   new String[] {
			 "group", "#devices:1"
		   });		
		addAnnotation
		  (getScaDeviceManager_FileSystem(), 
		   source, 
		   new String[] {
			 "kind", "element",
			 "name", "fileSystem"
		...
		addAnnotation
		  (getScaDeviceManager_Identifier(), 
		   source, 
		   new String[] {
			 "kind", "attribute",
			 "name", "identifier"
		...
		addAnnotation
		  (scaDeviceManagerFileSystemEClass, 
		   source, 
		   new String[] {
			 "name", "ScaDeviceManagerFileSystem",
			 "kind", "empty"
		   });		
		addAnnotation
		  (scaDocumentRootEClass, 
		   source, 
		   new String[] {
			 "name", "",
			 "kind", "mixed"
		...
		addAnnotation
		  (getScaDocumentRoot_XMLNSPrefixMap(), 
		   source, 
		   new String[] {
			 "kind", "attribute",
			 "name", "xmlns:prefix"
		...
		addAnnotation
		  (getScaDocumentRoot_XSISchemaLocation(), 
		   source, 
		   new String[] {
			 "kind", "attribute",
		...
		addAnnotation
		  (getScaDocumentRoot_DomainManagerRegistry(), 
		   source, 
		   new String[] {
			 "kind", "element",
			 "name", "domainManagerRegistry",
			 "namespace", "##targetNamespace"
		   });		
		addAnnotation
		  (scaDomainManagerEClass, 
		   source, 
		   new String[] {
			 "name", "ScaDomainManager",
			 "kind", "elementOnly"
		   });		
		addAnnotation
		  (getScaDomainManager_WaveformFactories(), 
		   source, 
		   new String[] {
			 "kind", "element",
			 "name", "waveformFactories"
		   });		
		addAnnotation
		  (getScaDomainManager_Waveforms(), 
		   source, 
		   new String[] {
			 "kind", "element",
			 "name", "waveforms"
		...
		addAnnotation
		  (getScaDomainManager_DeviceManagers(), 
		   source, 
		   new String[] {
			 "kind", "element",
			 "name", "deviceManagers"
		...
		addAnnotation
		  (getScaDomainManager_FileManager(), 
		   source, 
		   new String[] {
			 "kind", "element",
			 "name", "fileManager"
		...
		addAnnotation
		  (getScaDomainManager_ConnectionPropertiesContainer(), 
		   source, 
		   new String[] {
			 "kind", "element",
		...
		addAnnotation
		  (getScaDomainManager_ConnectionProperties(), 
		   source, 
		   new String[] {
			 "kind", "element",
			 "name", "connectionPropertiesTransient"
		   });		
		addAnnotation
		  (getScaDomainManager_AutoConnect(), 
		   source, 
		   new String[] {
			 "kind", "attribute",
			 "name", "autoConnect"
		...
		addAnnotation
		  (getScaDomainManager_Identifier(), 
		   source, 
		   new String[] {
			 "kind", "attribute",
			 "name", "identifier"
		...
		addAnnotation
		  (getScaDomainManager_RootContext(), 
		   source, 
		   new String[] {
			 "kind", "attribute",
			 "name", "rootContext"
		...
		addAnnotation
		  (scaDomainManagerFileSystemEClass, 
		   source, 
		   new String[] {
			 "name", "ScaDomainManagerFileSystem",
			 "kind", "empty"
		   });		
		addAnnotation
		  (getScaDomainManagerFileSystem_DomMgr(), 
		   source, 
		   new String[] {
			 "kind", "attribute",
			 "name", "domMgr"
		...
		addAnnotation
		  (scaDomainManagerRegistryEClass, 
		   source, 
		   new String[] {
			 "name", "ScaDomainManagerRegistry",
			 "kind", "elementOnly"
		   });		
		addAnnotation
		  (getScaDomainManagerRegistry_Domains(), 
		   source, 
		   new String[] {
			 "kind", "element",
			 "name", "domain"
		...
		addAnnotation
		  (scaExecutableDeviceEClass, 
		   source, 
		   new String[] {
			 "name", "ScaExecutableDevice",
			 "kind", "elementOnly"
		   });		
		addAnnotation
		  (scaFileManagerEClass, 
		   source, 
		   new String[] {
			 "name", "ScaFileManager",
			 "kind", "empty"
		...
		addAnnotation
		  (getScaFileSystem_FileSystemURI(), 
		   source, 
		   new String[] {
			 "kind", "attribute",
			 "name", "fileSystemURI"
		...
		addAnnotation
		  (scaLoadableDeviceEClass, 
		   source, 
		   new String[] {
			 "name", "ScaLoadableDevice",
			 "kind", "elementOnly"
		   });		
		addAnnotation
		  (scaPortEClass, 
		...
		addAnnotation
		  (scaProvidesPortEClass, 
		   source, 
		   new String[] {
			 "name", "ScaProvidesPort",
			 "kind", "empty"
		   });		
		addAnnotation
		  (scaSimplePropertyEClass, 
		   source, 
		   new String[] {
			 "name", "ScaSimpleProperty",
			 "kind", "empty"
		   });		
		addAnnotation
		  (getScaSimpleProperty_Value(), 
		   source, 
		   new String[] {
			 "kind", "attribute",
			 "name", "currentValue"
		...
		addAnnotation
		  (scaSimpleSequencePropertyEClass, 
		   source, 
		   new String[] {
			 "name", "ScaSimpleSequenceProperty",
			 "kind", "empty"
		   });		
		addAnnotation
		  (getScaSimpleSequenceProperty_Values(), 
		   source, 
		   new String[] {
			 "kind", "attribute",
			 "name", "currentValue"
		...
		addAnnotation
		  (scaStructPropertyEClass, 
		   source, 
		   new String[] {
			 "name", "ScaStructProperty",
			 "kind", "empty"
		   });		
		addAnnotation
		  (getScaStructProperty_Simples(), 
		   source, 
		   new String[] {
			 "kind", "attribute",
			 "name", "simples"
		...
		addAnnotation
		  (getScaWaveform_AssemblyController(), 
		   source, 
		   new String[] {
			 "kind", "attribute",
		...
		addAnnotation
		  (scaWaveformFactoryEClass, 
		   source, 
		   new String[] {
			 "name", "ScaWaveformFactory",
			 "kind", "empty"
		   });		
		addAnnotation
		  (getScaWaveformFactory_DomMgr(), 
		   source, 
		   new String[] {
			 "kind", "attribute",
			 "name", "domMgr"
		...
		addAnnotation
		  (getScaWaveformFactory_Identifier(), 
		   source, 
		   new String[] {
			 "kind", "attribute",
			 "name", "identifier"
		...
		addAnnotation
		  (usageTypeEDataType, 
		   ...
		   new String[] {
			 "name", "UsageType",
			 "enumeration", "ACTIVE BUSY IDLE"
		   });		
		addAnnotation
		  (scaStructSequencePropertyEClass, 
		   source, 
		   new String[] {
			 "name", "ScaStructSequenceProperty",
			 "kind", "empty"
		   });		
		addAnnotation
		  (getScaStructSequenceProperty_Structs(), 
		   source, 
		   new String[] {
			 "kind", "attribute",
			 "name", "simples"
