...
public class StringToStringMapImpl extends EObjectImpl implements BasicEMap.Entry<String, String> {
	...
	protected EClass eStaticClass() {
		return ScaPackage.Literals.STRING_TO_STRING_MAP;
	}
	...
	public void setTypedKey(String newKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ScaPackage.STRING_TO_STRING_MAP__KEY, oldKey, key));
	}
	...
	public void setTypedValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ScaPackage.STRING_TO_STRING_MAP__VALUE, oldValue, value));
	}
