...
public interface ScaDevice< D extends Device > extends ScaAbstractComponent<D>, DeviceOperations {
	 ...
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Admin State</em>' attribute isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 ...
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Usage State</em>' attribute isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 ...
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Dev Mgr</em>' reference isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
