...
public class UnallocatedTunerContainerImpl extends MinimalEObjectImpl.Container implements UnallocatedTunerContainer
{
  ...
  {
    if (eContainerFeatureID() != FrontendPackage.UNALLOCATED_TUNER_CONTAINER__TUNER_CONTAINER) return null;
  ...
  {
    if (newTunerContainer != eInternalContainer() || (eContainerFeatureID() != FrontendPackage.UNALLOCATED_TUNER_CONTAINER__TUNER_CONTAINER && newTunerContainer != null))
    {
      ...
      if (newTunerContainer != null)
        msgs = ((InternalEObject)newTunerContainer).eInverseAdd(this, FrontendPackage.TUNER_CONTAINER__UNALLOCATED_CONTAINER, TunerContainer.class, msgs);
      msgs = basicSetTunerContainer(newTunerContainer, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FrontendPackage.UNALLOCATED_TUNER_CONTAINER__TUNER_CONTAINER, newTunerContainer, newTunerContainer));
  }
