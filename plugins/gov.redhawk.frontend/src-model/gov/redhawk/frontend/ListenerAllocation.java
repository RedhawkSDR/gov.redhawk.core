...
public interface ListenerAllocation extends EObject
{
   ...
   * It is bidirectional and its opposite is '{@link gov.redhawk.frontend.TunerStatus#getListenerAllocations <em>Listener Allocations</em>}'.
   * <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * Sets the value of the '{@link gov.redhawk.frontend.ListenerAllocation#getTunerStatus <em>Tuner Status</em>}' container reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Sets the value of the '{@link gov.redhawk.frontend.ListenerAllocation#getListenerID <em>Listener ID</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
