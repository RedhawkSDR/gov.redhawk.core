...
public class FrontendAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected FrontendSwitch<Adapter> modelSwitch =
    new FrontendSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseTuner(Tuner object)
      {
        return createTunerAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link gov.redhawk.frontend.Tuner <em>Tuner</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
