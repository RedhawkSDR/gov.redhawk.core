...
/* Production 6 */
  ...
  Comment comment = popComment();
    ...
    retVal.setEndLine(endLine);
    retVal.setEndColumn(endColumn);
    IdlInterfaceDcl interfaceStub = IdlFactory.eINSTANCE.createIdlInterfaceDcl();
...
/* Production 37 */
  final public UnaryType unary_operator() throws ParseException {
    ...
    case 91:
      jj_consume_token(91);
    {if (true) return UnaryType.NEGATIVE;}
      break;
    case 90:
      jj_consume_token(90);
    {if (true) return UnaryType.POSITIVE;}
      break;
    case 95:
      jj_consume_token(95);
    {if (true) return UnaryType.TILDE;}
      break;
    default:
      jj_la1[46] = jj_gen;
      jj_consume_token(-1);
...
/* Production 56 */
  final public gov.redhawk.eclipsecorba.idl.types.Short signed_short_int() throws ParseException {
    ...
    {if (true) return TypesFactory.eINSTANCE.createShort();}
    throw new Error("Missing return statement in function");
  }
...
/* Production 57 */
  final public gov.redhawk.eclipsecorba.idl.types.Long signed_long_int() throws ParseException {
    jj_consume_token(LONG);
    {if (true) return TypesFactory.eINSTANCE.createLong();}
    throw new Error("Missing return statement in function");
  }
...
/* Production 58 */
  final public gov.redhawk.eclipsecorba.idl.types.LongLong signed_long_long() throws ParseException {
    jj_consume_token(LONG);
    jj_consume_token(LONG);
    {if (true) return TypesFactory.eINSTANCE.createLongLong();}
    throw new Error("Missing return statement in function");
  }
...
/* Production 60 */
  final public UShort unsigned_short_int() throws ParseException {
    ...
    jj_consume_token(SHORT);
    {if (true) return TypesFactory.eINSTANCE.createUShort();}
    throw new Error("Missing return statement in function");
  }
...
/* Production 61 */
  final public ULong unsigned_long_int() throws ParseException {
    jj_consume_token(UNSIGNED);
    jj_consume_token(LONG);
    {if (true) return TypesFactory.eINSTANCE.createULong();}
    throw new Error("Missing return statement in function");
  }
...
/* Production 62 */
  final public ULongLong unsigned_long_long_int() throws ParseException {
    ...
    jj_consume_token(LONG);
    jj_consume_token(LONG);
    {if (true) return TypesFactory.eINSTANCE.createULongLong();}
    throw new Error("Missing return statement in function");
  }
...
/* Production 63 */
  final public IdlChar char_type() throws ParseException {
    ...
    {if (true) return TypesFactory.eINSTANCE.createIdlChar();}
    throw new Error("Missing return statement in function");
  }
...
/* Production 64 */
  final public IdlWChar wide_char_type() throws ParseException {
    ...
    {if (true) return TypesFactory.eINSTANCE.createIdlWChar();}
    throw new Error("Missing return statement in function");
  }
...
/* Production 65 */
  final public gov.redhawk.eclipsecorba.idl.types.Boolean boolean_type() throws ParseException {
    ...
    {if (true) return TypesFactory.eINSTANCE.createBoolean();}
    throw new Error("Missing return statement in function");
  }
...
/* Production 66 */
  final public Octet octet_type() throws ParseException {
    ...
    {if (true) return TypesFactory.eINSTANCE.createOctet();}
    throw new Error("Missing return statement in function");
  }
...
/* Production 67 */
  final public Any any_type() throws ParseException {
    ...
    {if (true) return TypesFactory.eINSTANCE.createAny();}
    throw new Error("Missing return statement in function");
  }
...
/* Production 68 */
  final public IdlObject object_type() throws ParseException {
    ...
    {if (true) return TypesFactory.eINSTANCE.createIdlObject();}
    throw new Error("Missing return statement in function");
  }
...
/* Production 92 */
  final public Direction param_attribute() throws ParseException {
    ...
    case IN:
      jj_consume_token(IN);
    {if (true) return Direction.IN;}
      break;
    case OUT:
      jj_consume_token(OUT);
    {if (true) return Direction.OUT;}
      break;
    case INOUT:
      jj_consume_token(INOUT);
    {if (true) return Direction.INOUT;}
      break;
    default:
      jj_la1[81] = jj_gen;
      jj_consume_token(-1);
...
/* Production 98 */
  final public ValueBaseType value_base_type() throws ParseException {
    ...
    {if (true) return TypesFactory.eINSTANCE.createValueBaseType();}
    throw new Error("Missing return statement in function");
  }
...
/* Production 138 */
    ...
    jj_consume_token(ID);
        ...
        for (String str : IDLParserConstants.tokenImage) {
                if (str.equalsIgnoreCase(id)) {
                        {if (true) throw new ParseException("Identifier matches reserved word: " + str);}
                }
        }
  ...
  private boolean jj_3R_150() {
    if (jj_scan_token(VALUE_BASE)) return true;
    return false;
  }
  ...
  private boolean jj_3R_152() {
    if (jj_scan_token(IDL_STRING)) return true;
    Token xsp;
    xsp = jj_scanpos;
  ...
  private boolean jj_3R_180() {
    if (jj_scan_token(RAISES)) return true;
    if (jj_scan_token(82)) return true;
    if (jj_3R_105()) return true;
    Token xsp;
    while (true) {
  ...
  private boolean jj_3R_147() {
    if (jj_scan_token(OCTET)) return true;
    return false;
  }
  ...
  private boolean jj_3R_283() {
    if (jj_scan_token(FIXED_PT)) return true;
    return false;
  }
  ...
  private boolean jj_3R_281() {
    if (jj_scan_token(WSTRING_LITERAL)) return true;
    return false;
  }
  ...
  private boolean jj_3R_199() {
    if (jj_scan_token(ONEWAY)) return true;
    return false;
  }
  ...
  private boolean jj_3R_134() {
    if (jj_scan_token(FACTORY)) return true;
    if (jj_3R_61()) return true;
    if (jj_scan_token(82)) return true;
    Token xsp;
    xsp = jj_scanpos;
  ...
  private boolean jj_3R_143() {
    if (jj_scan_token(TYPEPREFIX)) return true;
    if (jj_3R_105()) return true;
    if (jj_3R_176()) return true;
    return false;
  }
  ...
  private boolean jj_3R_112() {
    if (jj_scan_token(SUPPORTS)) return true;
    if (jj_3R_135()) return true;
    Token xsp;
    while (true) {
      xsp = jj_scanpos;
  ...
  private boolean jj_3R_62() {
    ...
    if (jj_scan_token(EVENTTYPE)) return true;
    if (jj_3R_61()) return true;
    xsp = jj_scanpos;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x4ad41800,0x4ad41800,0x8000800,0x501000,0x4a000800,0x4ad41800,0x840800,0x800800,0x800800,0x800800,0x800800,0x0,0x56711000,0x56711000,0x0,0x0,0x0,0x800,0x800,0x800,0x800,0x0,0x56711000,0x56791000,0x0,0x0,0x8000,0x0,0x0,0x0,0x56791000,0x80000,0x0,0x20000000,0x0,0x14000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x500000,0x14410000,0x14010000,0x14010000,0x0,0x400000,0x0,0x0,0x10000000,0x10000000,0x10000000,0x0,0x14410000,0x14400000,0x80000000,0x80000000,0x80000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x14410000,0x0,0x20000000,0x0,0x14010000,0x0,0x2000,0x2000,0x0,0x0,0x14010000,0x0,0x0,0x0,0x0,0x20000000,0x0,0x20000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1224000,0x1224000,0x0,0x0,0x0,0x0,0x0,0x56711000,0x56711000,0x0,0x20000000,0x0,0x20000000,0x800,0x8000800,0x800,0x0,0x56711000,0x56791000,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x34404b02,0x34404b02,0x10000000,0x4004900,0x30400202,0x34404b02,0x0,0x0,0x0,0x0,0x0,0x0,0xe3b491c,0xe3b491c,0x0,0x0,0x0,0x0,0x400000,0x400000,0x0,0x0,0xe3b491c,0xe3b491d,0x10000000,0x0,0x0,0x0,0x0,0x80000000,0xe3b491d,0x0,0x0,0x0,0x0,0x388010,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x20,0x20,0x20,0x4000900,0x43b9118,0x3b9018,0x130018,0x209000,0x4000100,0x0,0x0,0x80000,0x10008,0x10000,0x8,0x43b9118,0x10018,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x4,0x0,0x43b9118,0x2000000,0x0,0x800000,0x83b0018,0x0,0x40000000,0x40000000,0x0,0x0,0x3b0018,0x4000000,0x100,0x0,0x0,0x0,0x0,0x0,0x80,0x1000080,0x0,0x200,0x0,0x80000000,0x0,0x42004,0x42004,0x0,0x40,0x0,0x80000000,0x0,0xe3b4d1d,0xe3b4d1d,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xe3b491c,0xe3b491d,0x10000000,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x8000,0x20441,0x20441,0x10000,0x20000,0x20000,0x0,0x0,0x0,0x0,0x8000,0x20441,0x20541,0x0,0x8000,0x0,0x10000,0x10000,0x0,0x20541,0x100,0x80,0x0,0x10000,0x20061,0x200000,0x400000,0x800000,0x3000000,0x3000000,0xc000000,0xc000000,0x70000000,0x70000000,0x8c000000,0x8c000000,0x60200,0x200,0x200,0x0,0x20461,0x20461,0x401,0x20,0x0,0x10000,0x0,0x40,0x0,0x0,0x0,0x20461,0x20000,0x2,0x2,0x2,0x10000,0x10000,0x0,0x0,0x0,0x0,0x10000,0x20461,0x0,0x0,0x0,0x20441,0x10000,0x80,0x80,0x10000,0x10000,0x20441,0x0,0x0,0x20000,0x10000,0x0,0x10000,0x0,0x0,0x0,0x10000,0x0,0x8000,0x0,0x10000,0x0,0x0,0x20400,0x0,0x8000,0x0,0x8,0x20441,0x20441,0x80,0x0,0x80,0x0,0x0,0x0,0x0,0x8000,0x20441,0x20541,0x0,0x8000,0x0,0x0,};
   }
   private static void jj_la1_init_3() {
      jj_la1_3 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x10,0x10,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x10,0x10,0x0,0x0,0x0,0x0,0x0,0x0,0x10,0x0,0x0,0x0,0x0,0x10,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x7ff0,0x7fe0,0x0,0x0,0x10,0x10,0x0,0x0,0x0,0x0,0x10,0x0,0x0,0x0,0x0,0x10,0x10,0x0,0x0,0x0,0x0,0x0,0x1,0x1,0x4,0x0,0x0,0x10,0x0,0x0,0x0,0x10,0x0,0x0,0x0,0x0,0x0,0x10,0x0,0x0,0x2010,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x10,0x0,0x0,0x0,0x0,0x10,0x10,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x10,0x10,0x0,0x0,0x160,0x600,};
   }
