 ...
 * <ul>
 *   <li>{@link gov.redhawk.eclipsecorba.idl.types.impl.EnumTypeImpl#getEnumerators <em>Enumerators</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EnumTypeImpl extends IdlTypeDclImpl implements EnumType {
	 ...
	 * @ordered
	 */
	protected EList<Enumeration> enumerators;
	 ...
	 * @generated
	 */
	public EList<Enumeration> getEnumerators() {
		if (enumerators == null) {
			enumerators = new EObjectContainmentEList<Enumeration>(Enumeration.class, this, TypesPackage.ENUM_TYPE__ENUMERATORS);
		}
		return enumerators;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case TypesPackage.ENUM_TYPE__ENUMERATORS:
				...
				getEnumerators().addAll((Collection<? extends Enumeration>)newValue);
				return;
		}
