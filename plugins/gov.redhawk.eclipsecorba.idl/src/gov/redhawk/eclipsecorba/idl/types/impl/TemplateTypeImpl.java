...
import gov.redhawk.eclipsecorba.idl.impl.IdlTypeImpl;
 ...
 * <ul>
 *   <li>{@link gov.redhawk.eclipsecorba.idl.types.impl.TemplateTypeImpl#getSize <em>Size</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class TemplateTypeImpl extends IdlTypeImpl implements TemplateType {
	...
	public NotificationChain basicSetSize(Expression newSize, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TypesPackage.TEMPLATE_TYPE__SIZE, oldSize, newSize);
	...
	public void setSize(Expression newSize) {
		if (newSize != size) {
			...
			if (size != null)
				msgs = ((InternalEObject)size).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TypesPackage.TEMPLATE_TYPE__SIZE, null, msgs);
			if (newSize != null)
				msgs = ((InternalEObject)newSize).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TypesPackage.TEMPLATE_TYPE__SIZE, null, msgs);
			msgs = basicSetSize(newSize, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.TEMPLATE_TYPE__SIZE, newSize, newSize));
	}
