 ...
 * <ul>
 *   <li>{@link gov.redhawk.eclipsecorba.idl.expressions.impl.CharacterLiteralImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CharacterLiteralImpl extends ExpressionImpl implements CharacterLiteral {
	...
	protected EClass eStaticClass() {
		return ExpressionsPackage.Literals.CHARACTER_LITERAL;
	}
	...
	public void setValue(char newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExpressionsPackage.CHARACTER_LITERAL__VALUE, oldValue, value));
	}
