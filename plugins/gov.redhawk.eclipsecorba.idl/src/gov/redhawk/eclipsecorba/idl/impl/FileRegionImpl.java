 ...
 * <ul>
 *   <li>{@link gov.redhawk.eclipsecorba.idl.impl.FileRegionImpl#getStartLine <em>Start Line</em>}</li>
 *   <li>{@link gov.redhawk.eclipsecorba.idl.impl.FileRegionImpl#getStartColumn <em>Start Column</em>}</li>
 *   <li>{@link gov.redhawk.eclipsecorba.idl.impl.FileRegionImpl#getEndLine <em>End Line</em>}</li>
 *   <li>{@link gov.redhawk.eclipsecorba.idl.impl.FileRegionImpl#getEndColumn <em>End Column</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class FileRegionImpl extends EObjectImpl implements FileRegion {
	...
	public void setStartLine(int newStartLine) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IdlPackage.FILE_REGION__START_LINE, oldStartLine, startLine));
	}
	...
	public void setStartColumn(int newStartColumn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IdlPackage.FILE_REGION__START_COLUMN, oldStartColumn, startColumn));
	}
	...
	public void setEndLine(int newEndLine) {
		...
		endLine = newEndLine;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IdlPackage.FILE_REGION__END_LINE, oldEndLine, endLine));
	}
	...
	public void setEndColumn(int newEndColumn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IdlPackage.FILE_REGION__END_COLUMN, oldEndColumn, endColumn));
	}
