 ...
 * <ul>
 *   <li>{@link gov.redhawk.eclipsecorba.idl.operations.impl.ParameterImpl#getDirection <em>Direction</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ParameterImpl extends TypedElementImpl implements Parameter {
	...
	protected EClass eStaticClass() {
		return OperationsPackage.Literals.PARAMETER;
	}
	...
	public void setDirection(Direction newDirection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OperationsPackage.PARAMETER__DIRECTION, oldDirection, direction));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OperationsPackage.PARAMETER__DIRECTION:
				return getDirection();
		}
