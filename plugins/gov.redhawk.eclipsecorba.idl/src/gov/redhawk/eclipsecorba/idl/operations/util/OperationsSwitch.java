...
package gov.redhawk.eclipsecorba.idl.operations.util;
 ...
 * <!-- end-user-doc -->
 * @see gov.redhawk.eclipsecorba.idl.operations.OperationsPackage
 * @generated
 */
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case OperationsPackage.OPERATION: {
				...
				if (result == null) result = caseExport(operation);
				if (result == null) result = caseCommentable(operation);
				if (result == null) result = caseTypedElement(operation);
				if (result == null) result = caseElement(operation);
				if (result == null) result = caseTyped(operation);
				if (result == null) result = caseIdentifiable(operation);
				if (result == null) result = caseFileRegion(operation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OperationsPackage.PARAMETER: {
				...
				if (result == null) result = caseFileRegion(parameter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OperationsPackage.ATTRIBUTE: {
				Attribute attribute = (Attribute)theEObject;
				T result = caseAttribute(attribute);
				if (result == null) result = caseExport(attribute);
				if (result == null) result = caseTypedElement(attribute);
				if (result == null) result = caseElement(attribute);
				if (result == null) result = caseTyped(attribute);
				if (result == null) result = caseIdentifiable(attribute);
				if (result == null) result = caseFileRegion(attribute);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
