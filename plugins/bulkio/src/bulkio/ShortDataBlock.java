...
public class ShortDataBlock
{
    ...
    protected CF.complexShort[] _interleaved_to_complex(short[] values)
    {
        CF.complexShort[] retval = new CF.complexShort[values.length/2];
    ...
    public ShortDataBlock(BULKIO.StreamSRI sri, short[] data, int sriChangeFlags, boolean inputQueueFlushed) {
        this._sri = sri;
        this._data = data;
