 ...
 * 
 */
public class InUInt16Port extends BULKIO.jni.dataUshortPOA implements InDataPort<BULKIO.dataUshortOperations,short[]> {
     ...
     * 
     */
    public InUInt16Port( String portName ) {
    ...
    public InUInt16Port( String portName, Logger logger ) {
    ...
    public InUInt16Port( String portName,
                       ...
                       bulkio.sri.Comparator compareSRI,
                       bulkio.SriListener sriCallback ) {
        impl = new InPortImpl<short[]>(portName, logger, compareSRI, sriCallback, new UInt16DataHelper());
    }
