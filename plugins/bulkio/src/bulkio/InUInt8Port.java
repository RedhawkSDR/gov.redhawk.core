 ...
 * 
 */
public class InUInt8Port extends BULKIO.jni.dataOctetPOA implements InDataPort<BULKIO.dataOctetOperations,byte[]> {
     ...
     * 
     */
    public InUInt8Port( String portName ) {
    ...
    public InUInt8Port( String portName, Logger logger ) {
    ...
    public InUInt8Port( String portName,
                       ...
                       bulkio.sri.Comparator compareSRI,
                       bulkio.SriListener sriCallback ) {
        impl = new InPortImpl<byte[]>(portName, logger, compareSRI, sriCallback, new UInt8DataHelper());
    }
