...
public class LongDataBlock
{
    ...
    protected CF.complexLong[] _interleaved_to_complex(int[] values)
    {
        CF.complexLong[] retval = new CF.complexLong[values.length/2];
    ...
    public LongDataBlock(BULKIO.StreamSRI sri, int[] data, int sriChangeFlags, boolean inputQueueFlushed) {
        this._sri = sri;
        this._data = data;
