 ...
 * 
 */
public class OutUInt8Port extends BULKIO.UsesPortStatisticsProviderPOA {
     ...
     * @generated
     */
    protected Map<String, dataOctetOperations> outConnections = null;
    ...
    public OutUInt8Port(String portName,
        ...
        active = false;
        outConnections = new HashMap<String, dataOctetOperations>();
     ...
     * @generated
     */
    public HashMap<String, dataOctetOperations> getPorts() {
        return new HashMap<String, dataOctetOperations>();
    }
	...
	if ( logger != null ) {
		...
		// for each connection
		for (Entry<String, dataOctetOperations> p : this.outConnections.entrySet()) {
            ...
            String streamID)
    {
        ...
        for (int offset = 0; offset < data.length;) {
            ...
            byte[] subPacket = Arrays.copyOfRange(data, offset, offset+pushSize);
            offset += pushSize;
     ...
     * @generated
     */
    public void pushPacket(byte[] data, PrecisionUTCTime time, boolean endOfStream, String streamID)
    {
        if ( logger != null ) {
