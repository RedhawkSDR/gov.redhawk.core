...
public class CharDataBlock
{
    ...
    protected CF.complexChar[] _interleaved_to_complex(char[] values)
    {
        CF.complexChar[] retval = new CF.complexChar[values.length/2];
    ...
    public CharDataBlock(BULKIO.StreamSRI sri, char[] data, int sriChangeFlags, boolean inputQueueFlushed) {
        this._sri = sri;
        this._data = data;
    ...
    public void setBuffer(char[] new_buffer)
    {
