...
public class ULongDataBlock
{
    ...
    protected CF.complexULong[] _interleaved_to_complex(int[] values)
    {
        CF.complexULong[] retval = new CF.complexULong[values.length/2];
    ...
    public ULongDataBlock(BULKIO.StreamSRI sri, int[] data, int sriChangeFlags, boolean inputQueueFlushed) {
        this._sri = sri;
        this._data = data;
    ...
    public void setBuffer(int[] new_buffer)
    {
