...
public class UShortDataBlock
{
    ...
    protected CF.complexUShort[] _interleaved_to_complex(short[] values)
    {
        CF.complexUShort[] retval = new CF.complexUShort[values.length/2];
    ...
    public UShortDataBlock(BULKIO.StreamSRI sri, short[] data, int sriChangeFlags, boolean inputQueueFlushed) {
        this._sri = sri;
        this._data = data;
    ...
    public void setBuffer(short[] new_buffer)
    {
    ...
    public CF.complexUShort[] cxdata()
    {
        /*"""
