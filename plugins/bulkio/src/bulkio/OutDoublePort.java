 ...
 * 
 */
public class OutDoublePort extends BULKIO.UsesPortStatisticsProviderPOA {
     ...
     * @generated
     */
    protected Map<String, dataDoubleOperations> outConnections = null;
     ...
     */
    protected static int MAX_SAMPLES_PER_PUSH = MAX_PAYLOAD_SIZE/DoubleSize.bytes();
            ...
            String streamID)
    {
        ...
        if (sriStruct.sri.subsize != 0) {
            if (MAX_SAMPLES_PER_PUSH%sriStruct.sri.subsize != 0) {
                MAX_SAMPLES_PER_PUSH = MAX_PAYLOAD_SIZE/DoubleSize.bytes();
