...
public class LongLongDataBlock
{
    /*"""
    ...
    protected CF.complexLongLong[] _interleaved_to_complex(long[] values)
    {
        CF.complexLongLong[] retval = new CF.complexLongLong[values.length/2];
    ...
    public LongLongDataBlock(BULKIO.StreamSRI sri, long[] data, int sriChangeFlags, boolean inputQueueFlushed) {
        this._sri = sri;
        this._data = data;
    ...
    public CF.complexLongLong[] cxdata()
    {
        /*"""
