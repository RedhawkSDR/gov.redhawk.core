...
public class DoubleDataBlock
{
    ...
    protected CF.complexDouble[] _interleaved_to_complex(double[] values)
    {
        CF.complexDouble[] retval = new CF.complexDouble[values.length/2];
    ...
    public DoubleDataBlock(BULKIO.StreamSRI sri, double[] data, int sriChangeFlags, boolean inputQueueFlushed) {
        this._sri = sri;
        this._data = data;
    ...
    public void setBuffer(double[] new_buffer)
    {
    ...
    public CF.complexDouble[] cxdata()
    {
        /*"""
