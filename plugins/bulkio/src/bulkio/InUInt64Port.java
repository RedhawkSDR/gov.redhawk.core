 ...
 * 
 */
public class InUInt64Port extends BULKIO.jni.dataUlongLongPOA implements InDataPort<BULKIO.dataUlongLongOperations,long[]> {
     ...
     * 
     */
    public InUInt64Port( String portName ) {
    ...
    public InUInt64Port( String portName, Logger logger ) {
    ...
    public InUInt64Port( String portName,
                       ...
                       bulkio.sri.Comparator compareSRI,
                       bulkio.SriListener sriCallback ) {
        impl = new InPortImpl<long[]>(portName, logger, compareSRI, sriCallback, new UInt64DataHelper());
    }
