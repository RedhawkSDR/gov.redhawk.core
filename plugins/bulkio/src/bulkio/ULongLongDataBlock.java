...
public class ULongLongDataBlock
{
    /*"""
    ...
    protected CF.complexULongLong[] _interleaved_to_complex(long[] values)
    {
        CF.complexULongLong[] retval = new CF.complexULongLong[values.length/2];
    ...
    public ULongLongDataBlock(BULKIO.StreamSRI sri, long[] data, int sriChangeFlags, boolean inputQueueFlushed) {
        this._sri = sri;
        this._data = data;
    ...
    public void setBuffer(long[] new_buffer)
    {
    ...
    public CF.complexULongLong[] cxdata()
    {
        /*"""
