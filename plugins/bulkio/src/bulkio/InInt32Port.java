 ...
 * 
 */
public class InInt32Port extends BULKIO.jni.dataLongPOA implements InDataPort<BULKIO.dataLongOperations,int[]> {
    ...
    public InInt32Port( String portName,
                       ...
                       bulkio.sri.Comparator compareSRI,
                       bulkio.SriListener sriCallback ) {
        impl = new InPortImpl<int[]>(portName, logger, compareSRI, sriCallback, new Int32DataHelper());
    }
