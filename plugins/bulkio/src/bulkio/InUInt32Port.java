 ...
 * 
 */
public class InUInt32Port extends BULKIO.jni.dataUlongPOA implements org.ossie.component.PortBase {
    ...
    public InUInt32Port( String portName, 
        ...
        this.name = portName;
	this.logger = logger;
        this.stats = new linkStatistics(this.name, new UInt32Size() );
