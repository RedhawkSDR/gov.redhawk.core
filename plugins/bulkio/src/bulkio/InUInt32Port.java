 ...
 * 
 */
public class InUInt32Port extends BULKIO.jni.dataUlongPOA implements InDataPort<BULKIO.dataUlongOperations,int[]> {
     ...
     * 
     */
    public InUInt32Port( String portName ) {
    ...
    public InUInt32Port( String portName, Logger logger ) {
    ...
    public InUInt32Port( String portName,
                       ...
                       bulkio.sri.Comparator compareSRI,
                       bulkio.SriListener sriCallback ) {
        impl = new InPortImpl<int[]>(portName, logger, compareSRI, sriCallback, new UInt32DataHelper());
    }
