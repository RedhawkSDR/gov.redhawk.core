...
public class OctetDataBlock
{
    ...
    protected CF.complexOctet[] _interleaved_to_complex(byte[] values)
    {
        CF.complexOctet[] retval = new CF.complexOctet[values.length/2];
    ...
    public OctetDataBlock(BULKIO.StreamSRI sri, byte[] data, int sriChangeFlags, boolean inputQueueFlushed) {
        this._sri = sri;
        this._data = data;
