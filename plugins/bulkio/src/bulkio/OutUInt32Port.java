 ...
 * 
 */
public class OutUInt32Port extends BULKIO.UsesPortStatisticsProviderPOA {
     ...
     * @generated
     */
    protected Map<String, dataUlongOperations> outConnections = null;
     ...
     */
    protected static int MAX_SAMPLES_PER_PUSH = MAX_PAYLOAD_SIZE/UInt32Size.bytes();
     ...
     * @generated
     */
    public HashMap<String, dataUlongOperations> getPorts() {
        return new HashMap<String, dataUlongOperations>();
    }
            ...
            String streamID)
    {
        ...
        if (sriStruct.sri.subsize != 0) {
            if (MAX_SAMPLES_PER_PUSH%sriStruct.sri.subsize != 0) {
                MAX_SAMPLES_PER_PUSH = MAX_PAYLOAD_SIZE/UInt32Size.bytes();
        ...
        for (int offset = 0; offset < data.length;) {
            ...
            int[] subPacket = Arrays.copyOfRange(data, offset, offset+pushSize);
            offset += pushSize;
    ...
    public UsesConnection[] connections() {
        ...
        synchronized (this.updatingPortsLock) {
            for (Entry<String, dataUlongOperations> ent : this.outConnections.entrySet()) {
