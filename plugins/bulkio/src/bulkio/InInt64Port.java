 ...
 * 
 */
public class InInt64Port extends BULKIO.jni.dataLongLongPOA implements org.ossie.component.PortBase {
    ...
    public InInt64Port( String portName, 
        ...
        this.name = portName;
	this.logger = logger;
        this.stats = new linkStatistics(this.name, new Int64Size() );
