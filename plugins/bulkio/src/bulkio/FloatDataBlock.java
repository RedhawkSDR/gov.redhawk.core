...
public class FloatDataBlock
{
    ...
    protected CF.complexFloat[] _interleaved_to_complex(float[] values)
    {
        CF.complexFloat[] retval = new CF.complexFloat[values.length/2];
    ...
    public FloatDataBlock(BULKIO.StreamSRI sri, float[] data, int sriChangeFlags, boolean inputQueueFlushed) {
        this._sri = sri;
        this._data = data;
    ...
    public void setBuffer(float[] new_buffer)
    {
