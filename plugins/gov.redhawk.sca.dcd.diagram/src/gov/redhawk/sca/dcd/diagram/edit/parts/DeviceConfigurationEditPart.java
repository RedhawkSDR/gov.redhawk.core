 ...
 * 
 */
public class DeviceConfigurationEditPart extends mil.jpeojtrs.sca.dcd.diagram.edit.parts.DeviceConfigurationEditPart {

	public DeviceConfigurationEditPart(final View view) {
		super(view);
	}
