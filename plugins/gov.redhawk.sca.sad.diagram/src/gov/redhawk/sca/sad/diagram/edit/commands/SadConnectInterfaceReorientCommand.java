 ...
 * @since 2.0
 */
public class SadConnectInterfaceReorientCommand extends mil.jpeojtrs.sca.sad.diagram.edit.commands.SadConnectInterfaceReorientCommand {

	/**
	 * Constructor
	 * @param request
	 */
	public SadConnectInterfaceReorientCommand(final ReorientRelationshipRequest request) {
		super(request);
	}
	...
	public boolean canExecute() {
		...
		if (retVal) {
			final SadConnectInterface connect = (SadConnectInterface) getElementToEdit();
