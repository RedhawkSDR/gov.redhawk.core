...
import mil.jpeojtrs.sca.scd.provider.UsesItemProvider;

public class PortsEditorUsesItemProvider extends UsesItemProvider {

	public PortsEditorUsesItemProvider(AdapterFactory adapterFactory) {
