...
/**
 * <!-- begin-user-doc -->
 * An object that monitors all the REDHAWK port(s) belonging to a component, device, etc.
 * <!-- end-user-doc -->
 *
 * <p>
 * The following features are supported:
 * <ul>
 * <li>{@link gov.redhawk.monitor.model.ports.PortSupplierMonitor#getPortContainer <em>Port Container</em>}</li>
 * <li>{@link gov.redhawk.monitor.model.ports.PortSupplierMonitor#getMonitors <em>Monitors</em>}</li>
 * </ul>
 * </p>
 *
 * @see gov.redhawk.monitor.model.ports.PortsPackage#getPortSupplierMonitor()
 * @model
 * @generated
 */
public interface PortSupplierMonitor extends Monitor {
	 ...
	 * @see gov.redhawk.monitor.model.ports.PortsPackage#getPortSupplierMonitor_PortContainer()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link gov.redhawk.monitor.model.ports.PortSupplierMonitor#getPortContainer <em>Port
	 ...
	 * The list contents are of type {@link gov.redhawk.monitor.model.ports.PortMonitor}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gov.redhawk.monitor.model.ports.PortsPackage#getPortSupplierMonitor_Monitors()
