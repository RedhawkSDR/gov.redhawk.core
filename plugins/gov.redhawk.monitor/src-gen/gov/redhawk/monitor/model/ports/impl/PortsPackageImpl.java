...
public class PortsPackageImpl extends EPackageImpl implements PortsPackage {
	 ...
	 * @see gov.redhawk.monitor.model.ports.PortsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static PortsPackage init() {
		if (isInited)
			return (PortsPackage) EPackage.Registry.INSTANCE.getEPackage(PortsPackage.eNS_URI);

		// Obtain or create and register package
		PortsPackageImpl thePortsPackage = (PortsPackageImpl) (EPackage.Registry.INSTANCE.get(eNS_URI) instanceof PortsPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI)
			: new PortsPackageImpl());
	...
	public void initializePackageContents() {
		...
		g1.getETypeArguments().add(g2);
		initEReference(getPortMonitor_Port(), g1, null, "port", null, 0, 1, PortMonitor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
			IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPortMonitor_Connections(), this.getPortConnectionMonitor(), this.getPortConnectionMonitor_Port(), "connections", null, 0, -1,
			PortMonitor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
			IS_ORDERED);
		initEAttribute(getPortMonitor_State(), this.getPortUsageType(), "state", null, 0, 1, PortMonitor.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
		...
		initEReference(getPortConnectionMonitor_Port(), this.getPortMonitor(), this.getPortMonitor_Connections(), "port", null, 0, 1,
			PortConnectionMonitor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED);
		initEAttribute(getPortConnectionMonitor_ConnectionId(), ecorePackage.getEString(), "connectionId", null, 0, 1, PortConnectionMonitor.class,
		...
		initEReference(getMonitorRegistry_Monitors(), this.getMonitor(), null, "monitors", null, 0, -1, MonitorRegistry.class, !IS_TRANSIENT, !IS_VOLATILE,
		...
		initEReference(getPortSupplierMonitor_PortContainer(), theScaPackage.getScaPortContainer(), null, "portContainer", null, 0, 1,
			PortSupplierMonitor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
			IS_ORDERED);
		initEReference(getPortSupplierMonitor_Monitors(), this.getPortMonitor(), null, "monitors", null, 0, -1, PortSupplierMonitor.class, !IS_TRANSIENT,
		...
		initEClass(portStatisticsProviderEClass, PortStatisticsProvider.class, "PortStatisticsProvider", !IS_ABSTRACT, !IS_INTERFACE,
			IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getPortStatisticsProvider_Data(), this.getPortStatistics(), "data", null, 0, 1, PortStatisticsProvider.class, IS_TRANSIENT,
