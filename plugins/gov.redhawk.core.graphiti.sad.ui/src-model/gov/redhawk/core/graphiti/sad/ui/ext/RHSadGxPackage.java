...
package gov.redhawk.core.graphiti.sad.ui.ext;
 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see gov.redhawk.core.graphiti.sad.ui.ext.RHSadGxFactory
 * @model kind="package"
 *        annotation="http://www.eclipse.org/emf/2002/GenModel prefix='RHSadGx' codeFormatting='true' modelPluginVariables='org.eclipse.xtext.xbase.lib' contentTypeIdentifier='http://www.redhawk.gov/model/rhsadgext/1.0.0' operationReflection='false' modelDirectory='/gov.redhawk.core.graphiti.sad.ui/src-model' basePackage='gov.redhawk.core.graphiti.sad.ui'"
...
public interface RHSadGxPackage extends EPackage {
	 ...
	 * @generated
	 */
	RHSadGxPackage eINSTANCE = gov.redhawk.core.graphiti.sad.ui.ext.impl.RHSadGxPackageImpl.init();

	/**
	 * The meta object id for the '{@link gov.redhawk.core.graphiti.sad.ui.ext.impl.ComponentShapeImpl <em>Component Shape</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see gov.redhawk.core.graphiti.sad.ui.ext.impl.ComponentShapeImpl
	 * @see gov.redhawk.core.graphiti.sad.ui.ext.impl.RHSadGxPackageImpl#getComponentShape()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for class '{@link gov.redhawk.core.graphiti.sad.ui.ext.ComponentShape <em>Component Shape</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Component Shape</em>'.
	 * @see gov.redhawk.core.graphiti.sad.ui.ext.ComponentShape
	 * @generated
	 */
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link gov.redhawk.core.graphiti.sad.ui.ext.impl.ComponentShapeImpl <em>Component Shape</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see gov.redhawk.core.graphiti.sad.ui.ext.impl.ComponentShapeImpl
		 * @see gov.redhawk.core.graphiti.sad.ui.ext.impl.RHSadGxPackageImpl#getComponentShape()
