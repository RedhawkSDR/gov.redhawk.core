 ...
 */
package gov.redhawk.core.graphiti.sad.ui.internal.editor;
	...
	private final IAction showPropertiesViewAction = new Action("Show &Properties View") {
		...
		public void run() {
			try {
				...
				StatusManager.getManager().handle(new Status(IStatus.ERROR, GraphitiSadUIPlugin.PLUGIN_ID, "Failed to open Property View.", exception),
