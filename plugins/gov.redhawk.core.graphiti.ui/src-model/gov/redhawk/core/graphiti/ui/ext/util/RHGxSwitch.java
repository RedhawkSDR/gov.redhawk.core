...
package gov.redhawk.core.graphiti.ui.ext.util;

import gov.redhawk.core.graphiti.ui.ext.*;
 ...
 * <!-- end-user-doc -->
 * @see gov.redhawk.core.graphiti.ui.ext.RHGxPackage
 * @generated
 */
public class RHGxSwitch< T > extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case RHGxPackage.RH_CONTAINER_SHAPE: {
			...
			if (result == null)
				result = caseContainerShape(rhContainerShape);
			if (result == null)
				result = caseShape(rhContainerShape);
			if (result == null)
				result = caseAnchorContainer(rhContainerShape);
			if (result == null)
				result = casePictogramElement(rhContainerShape);
			if (result == null)
				result = caseGraphicsAlgorithmContainer(rhContainerShape);
			if (result == null)
				result = casePropertyContainer(rhContainerShape);
			if (result == null)
