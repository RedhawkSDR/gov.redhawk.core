 ...
 * @generated
 */
public class SadValidationDecoratorProvider extends AbstractProvider implements
		IDecoratorProvider {
	 ...
	 * @generated
	 */
	private static final String MARKER_TYPE = SadDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof SadDiagramEditor) {
	...
	public boolean provides(IOperation operation) {
		...
		return view != null
				&& SoftwareAssemblyEditPart.MODEL_ID.equals(SadVisualIDRegistry
						.getModelID(view));
	}
