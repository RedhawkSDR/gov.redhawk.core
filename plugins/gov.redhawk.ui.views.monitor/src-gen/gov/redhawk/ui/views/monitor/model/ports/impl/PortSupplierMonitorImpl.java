 ...
 * <ul>
 *   <li>{@link gov.redhawk.ui.views.monitor.model.ports.impl.PortSupplierMonitorImpl#getPortContainer <em>Port Container</em>}</li>
 *   <li>{@link gov.redhawk.ui.views.monitor.model.ports.impl.PortSupplierMonitorImpl#getMonitors <em>Monitors</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
		...
		if (portContainer != null && portContainer.eIsProxy()) {
			...
			if (portContainer != oldPortContainer) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PortsPackage.PORT_SUPPLIER_MONITOR__PORT_CONTAINER, oldPortContainer, portContainer));
			}
		}
