	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PortsPackage.PORT_MONITOR: {
				...
				if (result == null) result = caseMonitor(portMonitor);
				if (result == null) result = casePortStatisticsProvider(portMonitor);
			...
			case PortsPackage.PORT_CONNECTION_MONITOR: {
				...
				if (result == null) result = casePortStatisticsProvider(portConnectionMonitor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case PortsPackage.PORT_SUPPLIER_MONITOR: {
				...
				if (result == null) result = caseMonitor(portSupplierMonitor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
