...
public class ComplexULongProperty extends AbstractSimpleProperty<complexULong> {
    public ComplexULongProperty(String id, String name, complexULong value, Mode mode, Action action, Kind[] kinds) {
    ...
    protected void insert(Any any, complexULong value) {
        complexULongHelper.insert(any, value);
    }

    protected complexULong parseString(String str) {
        return ComplexUtils.parseComplexULong(str);
    }
}
