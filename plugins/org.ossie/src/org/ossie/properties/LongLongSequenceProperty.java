...
public class LongLongSequenceProperty extends NumericSequenceProperty<Long> {
    public LongLongSequenceProperty(String id, String name, List<Long> value, Mode mode,
    ...
    protected void insert(Any any, List<Long> value) {
        LongLongSeqHelper.insert(any, PrimitiveArrayUtils.convertToLongArray(value));
    }
}
