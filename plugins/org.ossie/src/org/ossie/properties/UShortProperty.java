...
public class UShortProperty extends NumericProperty<Short> {
    public UShortProperty(String id, String name, Short value, Mode mode,
    ...
    protected Short parseString(String str) {
        return UnsignedUtils.parseUShort(str);
    }

    protected int compare(Short lhs, Short rhs) {
        return UnsignedUtils.compareUShort(lhs, rhs);
    }
