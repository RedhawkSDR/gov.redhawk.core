...
public class Messages extends NLS {
	private static final String BUNDLE_NAME = "gov.redhawk.efs.sca.internal.messages"; //$NON-NLS-1$
	public static String ScaFileEntry__NULL_URI;
	public static String ScaFileStore__Child_Info_Error;
