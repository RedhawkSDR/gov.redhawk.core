 ...
 * 
 */
public class NamingServiceItemSemanticEditPolicy extends PartitioningBaseItemSemanticEditPolicy {

	/**
	* 
	*/
	public NamingServiceItemSemanticEditPolicy(final PartitioningElementTypes elementTypes, final PartitioningVisualIDRegistry visualIdRegistry) {
		super(PartitioningElementTypes.NamingService, elementTypes, visualIdRegistry);
	}
