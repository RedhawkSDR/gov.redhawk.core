 ...
 * 
 */
public class ProvidesPortStubItemSemanticEditPolicyHelper {

	private final PartitioningElementTypes elementTypes;
	private final IProvidesPortStubItemSemanticEditPolicy editPolicy;

	public ProvidesPortStubItemSemanticEditPolicyHelper(final PartitioningElementTypes elementTypes, final IProvidesPortStubItemSemanticEditPolicy editPolicy) {
	...
	public boolean shouldProceed(final DestroyRequest destroyRequest, final EObject object) {
		if (object instanceof ProvidesPortStub) {
			final ProvidesPortStub stub = (ProvidesPortStub) object;
