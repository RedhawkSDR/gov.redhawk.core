 ...
 * 
 */
public interface IComponentSupportedInterfaceStubItemSemanticEditPolicy {

	Command getGEFWrapper(ConnectInterfaceCreateCommand connectInterfaceCreateCommand);
