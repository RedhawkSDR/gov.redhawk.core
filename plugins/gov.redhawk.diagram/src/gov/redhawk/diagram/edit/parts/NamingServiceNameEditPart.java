 ...
 * 
 */
public class NamingServiceNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {

	/**
	* 
	*/
	public static final int VISUAL_ID = 15013;
	...
	* 
	*/
	public NamingServiceNameEditPart(final View view, final PartitioningElementTypes elementTypes, final PartitioningVisualIDRegistry registry) {
		super(view);
	...
	public IParser getParser() {
		if (this.parser == null) {
			this.parser = PartitioningParserProviderHelper.getParser(PartitioningElementTypes.NamingService, getParserElement(),
			        this.registry.getType(NamingServiceNameEditPart.VISUAL_ID));
		}
		return this.parser;
	}
