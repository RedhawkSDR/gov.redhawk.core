 ...
 * 
 */
abstract class BaseCreateCommand extends EditElementCommand {

	protected BaseCreateCommand(final CreateElementRequest req) {
	...
	*/
	...
	protected void doConfigure(final EObject newElement, final IProgressMonitor monitor, final IAdaptable info) throws ExecutionException {
