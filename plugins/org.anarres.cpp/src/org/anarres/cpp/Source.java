...
*/
	 ...
	 */
	protected void setParent(Source parent, boolean autopop) {
		this.parent = parent;
	...
	// @OverrideMustInvoke
	protected void init(Preprocessor pp) {
	 ...
	 */
	protected boolean isExpanding(Macro m) {
		Source	parent = getParent();
		if (parent != null)
