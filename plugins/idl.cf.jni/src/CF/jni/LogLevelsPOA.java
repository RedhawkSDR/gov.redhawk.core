...
public abstract class LogLevelsPOA extends omnijni.Servant implements CF.LogLevelsOperations
{
  public LogLevelsPOA ()
  {
  }
  ...
  {
    this._activate();
    long ref = LogLevelsPOA.new_reference(this.servant_);
    CF.jni._LogLevelsStub stub = new CF.jni._LogLevelsStub(ref);
  ...
  {
    if (this.servant_ == 0) {
      this.servant_ = LogLevelsPOA.new_servant();
  ...
  {
    if (this.servant_ != 0) {
      LogLevelsPOA.del_servant(this.servant_);
      this.servant_ = 0;
    }
  }
  ...
  private static native void set_delegate (long servant, CF.LogLevelsOperations delegate);
