...
public abstract class DevicePOA extends omnijni.Servant implements CF.DeviceOperations
{
  public DevicePOA ()
  {
  }
  ...
  {
    this._activate();
    long ref = DevicePOA.new_reference(this.servant_);
    CF.jni._DeviceStub stub = new CF.jni._DeviceStub(ref);
  ...
  {
    if (this.servant_ == 0) {
      this.servant_ = DevicePOA.new_servant();
  ...
  {
    if (this.servant_ != 0) {
      DevicePOA.del_servant(this.servant_);
      this.servant_ = 0;
    }
  }
  ...
  private static native void set_delegate (long servant, CF.DeviceOperations delegate);
