...
public abstract class LoggingPOA extends omnijni.Servant implements CF.LoggingOperations
{
  public LoggingPOA ()
  {
  }
  ...
  {
    this._activate();
    long ref = LoggingPOA.new_reference(this.servant_);
    CF.jni._LoggingStub stub = new CF.jni._LoggingStub(ref);
  ...
  {
    if (this.servant_ == 0) {
      this.servant_ = LoggingPOA.new_servant();
  ...
  {
    if (this.servant_ != 0) {
      LoggingPOA.del_servant(this.servant_);
      this.servant_ = 0;
    }
  }
  ...
  private static native void set_delegate (long servant, CF.LoggingOperations delegate);
