...
public abstract class LifeCyclePOA extends omnijni.Servant implements CF.LifeCycleOperations
{
  public LifeCyclePOA ()
  {
  }
  ...
  {
    this._activate();
    long ref = LifeCyclePOA.new_reference(this.servant_);
    CF.jni._LifeCycleStub stub = new CF.jni._LifeCycleStub(ref);
  ...
  {
    if (this.servant_ == 0) {
      this.servant_ = LifeCyclePOA.new_servant();
  ...
  {
    if (this.servant_ != 0) {
      LifeCyclePOA.del_servant(this.servant_);
      this.servant_ = 0;
    }
  }
  ...
  private static native void set_delegate (long servant, CF.LifeCycleOperations delegate);
