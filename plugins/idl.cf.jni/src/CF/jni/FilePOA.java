...
public abstract class FilePOA extends omnijni.Servant implements CF.FileOperations
{
  public FilePOA ()
  {
  }
  ...
  {
    this._activate();
    long ref = FilePOA.new_reference(this.servant_);
    CF.jni._FileStub stub = new CF.jni._FileStub(ref);
  ...
  {
    if (this.servant_ == 0) {
      this.servant_ = FilePOA.new_servant();
  ...
  {
    if (this.servant_ != 0) {
      FilePOA.del_servant(this.servant_);
      this.servant_ = 0;
    }
  }
  ...
  private static native void set_delegate (long servant, CF.FileOperations delegate);
