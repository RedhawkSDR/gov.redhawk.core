...
public abstract class PortPOA extends omnijni.Servant implements CF.PortOperations
{
  public PortPOA ()
  {
  }
  ...
  {
    this._activate();
    long ref = PortPOA.new_reference(this.servant_);
    CF.jni._PortStub stub = new CF.jni._PortStub(ref);
  ...
  {
    if (this.servant_ == 0) {
      this.servant_ = PortPOA.new_servant();
  ...
  {
    if (this.servant_ != 0) {
      PortPOA.del_servant(this.servant_);
      this.servant_ = 0;
    }
  }
  ...
  private static native void set_delegate (long servant, CF.PortOperations delegate);
