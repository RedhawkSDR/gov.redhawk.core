...
public abstract class PropertySetPOA extends omnijni.Servant implements CF.PropertySetOperations
{
  ...
  {
    this._activate();
    long ref = PropertySetPOA.new_reference(this.servant_);
    CF.jni._PropertySetStub stub = new CF.jni._PropertySetStub(ref);
  ...
  {
    if (this.servant_ == 0) {
      this.servant_ = PropertySetPOA.new_servant();
  ...
  {
    if (this.servant_ != 0) {
      PropertySetPOA.del_servant(this.servant_);
      this.servant_ = 0;
    }
  }
  ...
  private static native void set_delegate (long servant, CF.PropertySetOperations delegate);
