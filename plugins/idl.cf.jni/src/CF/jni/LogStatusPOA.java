...
public abstract class LogStatusPOA extends omnijni.Servant implements CF.LogStatusOperations
{
  public LogStatusPOA ()
  {
  }
  ...
  {
    this._activate();
    long ref = LogStatusPOA.new_reference(this.servant_);
    CF.jni._LogStatusStub stub = new CF.jni._LogStatusStub(ref);
  ...
  {
    if (this.servant_ == 0) {
      this.servant_ = LogStatusPOA.new_servant();
  ...
  {
    if (this.servant_ != 0) {
      LogStatusPOA.del_servant(this.servant_);
      this.servant_ = 0;
    }
  }
  ...
  private static native void set_delegate (long servant, CF.LogStatusOperations delegate);
