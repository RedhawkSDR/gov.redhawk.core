...
public abstract class PortSetPOA extends omnijni.Servant implements CF.PortSetOperations
{
  public PortSetPOA ()
  {
  }
  ...
  {
    this._activate();
    long ref = PortSetPOA.new_reference(this.servant_);
    CF.jni._PortSetStub stub = new CF.jni._PortSetStub(ref);
  ...
  {
    if (this.servant_ == 0) {
      this.servant_ = PortSetPOA.new_servant();
  ...
  {
    if (this.servant_ != 0) {
      PortSetPOA.del_servant(this.servant_);
      this.servant_ = 0;
    }
  }
  ...
  private static native void set_delegate (long servant, CF.PortSetOperations delegate);
