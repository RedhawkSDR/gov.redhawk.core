...
public class FetchConnectionsJob extends Job {

	private ScaDomainManager domMgr;
	private ScaConnectionManager connMgr;
	private boolean shouldRun = true;

	public FetchConnectionsJob(ScaDomainManager domMgr, ScaConnectionManager connMgr) {
		super("Fetch connections");
		this.domMgr = domMgr;
