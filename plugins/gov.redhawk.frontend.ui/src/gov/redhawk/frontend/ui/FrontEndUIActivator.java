...
public class FrontEndUIActivator extends AbstractUIPlugin {
	...
	private static List<String> getSupportedTuner() {
		...
		Collections.addAll(supportedTunerTypes, FRONTEND.TUNER_TYPE_RX_DIGITIZER.value, FRONTEND.TUNER_TYPE_CHANNELIZER.value, FRONTEND.TUNER_TYPE_DDC.value,
			FRONTEND.TUNER_TYPE_RX.value, FRONTEND.TUNER_TYPE_RX_DIGITIZER_CHANNELIZER.value, FRONTEND.TUNER_TYPE_TX.value);
