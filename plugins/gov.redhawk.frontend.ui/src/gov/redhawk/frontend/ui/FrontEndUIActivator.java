...
public class FrontEndUIActivator extends AbstractUIPlugin {
	...
	private static List<String> getSupportedTuner() {
		return Collections.unmodifiableList(new ArrayList<String>(Arrays.asList(new String[] {
	...
	public static enum ALLOCATION_MODE { // SUPPRESS CHECKSTYLE TypeName - This is now API
		TUNER,
		LISTENER
	}
