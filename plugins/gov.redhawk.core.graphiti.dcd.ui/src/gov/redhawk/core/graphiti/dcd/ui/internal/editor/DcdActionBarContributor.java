 ...
 */
package gov.redhawk.core.graphiti.dcd.ui.internal.editor;
	...
	protected IAction showPropertiesViewAction = new Action("Show &Properties View") {
		...
		public void run() {
			try {
				...
				StatusManager.getManager().handle(new Status(IStatus.ERROR, GraphitiDcdUIPlugin.PLUGIN_ID, e.getMessage()),
