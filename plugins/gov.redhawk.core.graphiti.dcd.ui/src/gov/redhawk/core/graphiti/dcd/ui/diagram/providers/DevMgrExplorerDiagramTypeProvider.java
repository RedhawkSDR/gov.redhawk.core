...
public class DevMgrExplorerDiagramTypeProvider extends DCDDiagramTypeProvider {
	...
	public DevMgrExplorerDiagramTypeProvider() {
		super();
		setFeatureProvider(new DevMgrExplorerFeatureProvider(this));
	}

	@Override
	public IToolBehaviorProvider[] getAvailableToolBehaviorProviders() {
		if (toolBehaviorProviders == null) {
			toolBehaviorProviders = new IToolBehaviorProvider[] { new DevMgrExplorerToolBehaviorProvider(this) };
		}
