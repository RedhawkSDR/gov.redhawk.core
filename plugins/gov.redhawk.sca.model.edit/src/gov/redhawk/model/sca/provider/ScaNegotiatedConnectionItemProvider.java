...
public class ScaNegotiatedConnectionItemProvider extends ScaConnectionItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addTransportInfoPropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Transport Info feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addTransportInfoPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
			getString("_UI_ScaNegotiatedConnection_transportInfo_feature"),
			getString("_UI_PropertyDescriptor_description", "_UI_ScaNegotiatedConnection_transportInfo_feature", "_UI_ScaNegotiatedConnection_type"),
			ScaPackage.Literals.SCA_NEGOTIATED_CONNECTION__TRANSPORT_INFO, false, false, false, null, null, null));
	}
	...
	public Collection< ? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ScaPackage.Literals.SCA_NEGOTIATED_CONNECTION__TRANSPORT_INFO);
		}
