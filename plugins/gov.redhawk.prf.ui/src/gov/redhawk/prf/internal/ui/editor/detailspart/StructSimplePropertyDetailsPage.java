...
import gov.redhawk.prf.internal.ui.editor.composite.StructSimplePropertyComposite;
...
public class StructSimplePropertyDetailsPage extends SimplePropertyDetailsPage {
	 ...
	 */
	public StructSimplePropertyDetailsPage(final PropertiesSection section) {
		super(section);
	}
	
	@Override
	protected StructSimplePropertyComposite getComposite() {
	    return (StructSimplePropertyComposite) super.getComposite();
	}
