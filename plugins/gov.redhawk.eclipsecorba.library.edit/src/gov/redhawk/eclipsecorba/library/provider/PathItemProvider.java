...
/**
 * This is the item provider adapter for a {@link gov.redhawk.eclipsecorba.library.Path} object.
 * <!-- begin-user-doc -->
 * @since 3.0
 * <!-- end-user-doc -->
 * @generated
 */
public class PathItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Path_derivedPath_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Path_derivedPath_feature", "_UI_Path_type"),
				 LibraryPackage.Literals.PATH__DERIVED_PATH,
				 false,
				 false,
				 false,
