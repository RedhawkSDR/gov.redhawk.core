 ...
 * @generated
 */
public class DcdEditPartFactory implements EditPartFactory {
	...
	public EditPart createEditPart(EditPart context, Object model) {
		if (model instanceof View) {
			...
			case DeviceConfigurationEditPart.VISUAL_ID:
				return new DeviceConfigurationEditPart(view);

			case DcdPartitioningEditPart.VISUAL_ID:
				return new DcdPartitioningEditPart(view);

			case WrappingLabelEditPart.VISUAL_ID:
				return new WrappingLabelEditPart(view);

			case DcdComponentPlacementEditPart.VISUAL_ID:
				return new DcdComponentPlacementEditPart(view);

			case DcdComponentPlacementNameEditPart.VISUAL_ID:
				return new DcdComponentPlacementNameEditPart(view);

			case DcdComponentInstantiationEditPart.VISUAL_ID:
				return new DcdComponentInstantiationEditPart(view);

			case DcdComponentInstantiationUsageNameEditPart.VISUAL_ID:
				return new DcdComponentInstantiationUsageNameEditPart(view);
			...
			case DcdPartitioningCompartmentEditPart.VISUAL_ID:
				return new DcdPartitioningCompartmentEditPart(view);

			case DcdComponentPlacementCompartmentEditPart.VISUAL_ID:
				return new DcdComponentPlacementCompartmentEditPart(view);

			case DcdConnectInterfaceEditPart.VISUAL_ID:
				return new DcdConnectInterfaceEditPart(view);
