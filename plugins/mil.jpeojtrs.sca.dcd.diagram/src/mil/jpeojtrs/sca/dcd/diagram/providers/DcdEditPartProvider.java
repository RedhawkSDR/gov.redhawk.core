...
import mil.jpeojtrs.sca.dcd.diagram.edit.parts.DcdEditPartFactory;
 ...
 * @generated
 */
public class DcdEditPartProvider extends AbstractEditPartProvider {
	...
	public DcdEditPartProvider() {
		setFactory(new DcdEditPartFactory());
	...
	public synchronized boolean provides(IOperation operation) {
		if (operation instanceof CreateGraphicEditPartOperation) {
			...
			if (!DeviceConfigurationEditPart.MODEL_ID
					.equals(DcdVisualIDRegistry.getModelID(view))) {
				return false;
			}
