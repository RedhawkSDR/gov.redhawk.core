...
/**
 * This is the item provider adapter for a {@link gov.redhawk.eclipsecorba.idl.IdlConstDcl} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IdlConstDclItemProvider
	 ...
	 * @generated
	 */
	public IdlConstDclItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(IdlPackage.Literals.IDL_CONST_DCL__EXPRESSION);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/IdlConstDcl"));
	}
	...
	public String getText(Object object) {
		IdlConstDcl p = (IdlConstDcl) object;
		...
		return label == null || label.length() == 0 ?
			getString("_UI_IdlConstDcl_type") :
			label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(IdlConstDcl.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(IdlPackage.Literals.IDL_CONST_DCL__EXPRESSION,
