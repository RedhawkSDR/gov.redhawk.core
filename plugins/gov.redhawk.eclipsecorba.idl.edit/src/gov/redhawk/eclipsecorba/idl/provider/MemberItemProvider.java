...
/**
 * This is the item provider adapter for a {@link gov.redhawk.eclipsecorba.idl.Member} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MemberItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(IdlPackage.Literals.MEMBER__DECLARATORS);
		}
	...
	public String getText(Object object) {
		Member p = (Member) object;
		IItemLabelProvider lp = (IItemLabelProvider) getRootAdapterFactory().adapt(p.getType(), IItemLabelProvider.class);
		StringBuilder label = new StringBuilder();
		for (Iterator<Declarator> i = p.getDeclarators().iterator(); i.hasNext();) {
			Declarator dec = i.next();
			label.append(dec.getName());
			if (i.hasNext()) {
				label.append(", ");
			}
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(IdlPackage.Literals.MEMBER__DECLARATORS,
