...
/**
 * This is the item provider adapter for a {@link gov.redhawk.eclipsecorba.idl.Comment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CommentItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 IdlPackage.Literals.COMMENT__CONTENT,
				 false,
				 true,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Comment_type") + " " + comment.getStartLine();
	}
