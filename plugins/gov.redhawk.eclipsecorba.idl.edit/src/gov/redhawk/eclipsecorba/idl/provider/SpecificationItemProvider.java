...
/**
 * This is the item provider adapter for a {@link gov.redhawk.eclipsecorba.idl.Specification} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SpecificationItemProvider
extends DefinitionContainerItemProvider
implements
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 IdlPackage.Literals.SPECIFICATION__NAME,
				 false,
				 false,
				 false,
	...
	protected void addPrefixPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Specification_prefix_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Specification_prefix_feature", "_UI_Specification_type"),
				 IdlPackage.Literals.SPECIFICATION__PREFIX,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
