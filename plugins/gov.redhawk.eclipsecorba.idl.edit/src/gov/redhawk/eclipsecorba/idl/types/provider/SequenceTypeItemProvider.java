...
/**
 * This is the item provider adapter for a {@link gov.redhawk.eclipsecorba.idl.types.SequenceType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SequenceTypeItemProvider
	extends TemplateTypeItemProvider
	implements
	...
	public String getText(Object object) {
		SequenceType sequenceType = (SequenceType)object;
		IItemLabelProvider lp = (IItemLabelProvider) getRootAdapterFactory().adapt(sequenceType.getType(), IItemLabelProvider.class);
		return "sequence <"  + lp.getText(sequenceType.getType()) + ">";
	}
