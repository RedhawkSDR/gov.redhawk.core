...
/**
 * This is the item provider adapter for a {@link gov.redhawk.eclipsecorba.idl.types.StructType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StructTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_StructType_forwardDcl_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_StructType_forwardDcl_feature", "_UI_StructType_type"),
				 TypesPackage.Literals.STRUCT_TYPE__FORWARD_DCL,
				 false,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(IdlPackage.Literals.MEMBER_CONTAINER__MEMBERS);
			childrenFeatures.add(TypesPackage.Literals.STRUCT_TYPE__FORWARD_DECLARATION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(IdlPackage.Literals.MEMBER_CONTAINER__MEMBERS,
				 IdlFactory.eINSTANCE.createMember()));

		newChildDescriptors.add
			(createChildParameter
				(TypesPackage.Literals.STRUCT_TYPE__FORWARD_DECLARATION,
