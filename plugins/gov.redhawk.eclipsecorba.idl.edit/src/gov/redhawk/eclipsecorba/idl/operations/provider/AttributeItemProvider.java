...
/**
 * This is the item provider adapter for a {@link gov.redhawk.eclipsecorba.idl.operations.Attribute} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AttributeItemProvider
	extends ExportItemProvider
	implements
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Attribute_readOnly_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Attribute_readOnly_feature", "_UI_Attribute_type"),
				 OperationsPackage.Literals.ATTRIBUTE__READ_ONLY,
				 false,
				 false,
				 false,
