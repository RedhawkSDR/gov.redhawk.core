...
/**
 * This is the item provider adapter for a {@link gov.redhawk.eclipsecorba.idl.expressions.ShiftExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ShiftExpressionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ShiftExpression_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ShiftExpression_type_feature", "_UI_ShiftExpression_type"),
				 ExpressionsPackage.Literals.SHIFT_EXPRESSION__TYPE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ExpressionsPackage.Literals.SHIFT_EXPRESSION__LEFT);
			childrenFeatures.add(ExpressionsPackage.Literals.SHIFT_EXPRESSION__RIGHT);
		}
	...
	public String getText(Object object) {
		ShiftExpression shiftExpression = (ShiftExpression)object;
		Expression left = shiftExpression.getLeft();
		Expression right = shiftExpression.getRight();
		...
		return leftLp.getText(left) + shiftExpression.getType().getLiteral() + rightLp.getText(right);
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ExpressionsPackage.Literals.SHIFT_EXPRESSION__LEFT,
		...
		newChildDescriptors.add
			(createChildParameter
				(ExpressionsPackage.Literals.SHIFT_EXPRESSION__RIGHT,
				 ExpressionsFactory.eINSTANCE.createConstExpression()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == ExpressionsPackage.Literals.SHIFT_EXPRESSION__LEFT ||
			childFeature == ExpressionsPackage.Literals.SHIFT_EXPRESSION__RIGHT;
