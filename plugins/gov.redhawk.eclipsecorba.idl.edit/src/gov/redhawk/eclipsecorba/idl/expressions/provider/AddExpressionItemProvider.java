...
/**
 * This is the item provider adapter for a {@link gov.redhawk.eclipsecorba.idl.expressions.AddExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AddExpressionItemProvider
	 ...
	 * @generated
	 */
	public AddExpressionItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AddExpression_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AddExpression_type_feature", "_UI_AddExpression_type"),
				 ExpressionsPackage.Literals.ADD_EXPRESSION__TYPE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ExpressionsPackage.Literals.ADD_EXPRESSION__LEFT);
			childrenFeatures.add(ExpressionsPackage.Literals.ADD_EXPRESSION__RIGHT);
		}
	...
	/**
	 * This returns AddExpression.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/AddExpression"));
	}
	...
	public String getText(Object object) {
		AddExpression addExpression = (AddExpression)object;
		...
		return leftLp.getText(left) + addExpression.getType().getLiteral() + rightLp.getText(right);
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AddExpression.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ExpressionsPackage.Literals.ADD_EXPRESSION__LEFT,
		...
		newChildDescriptors.add
			(createChildParameter
				(ExpressionsPackage.Literals.ADD_EXPRESSION__RIGHT,
				 ExpressionsFactory.eINSTANCE.createConstExpression()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == ExpressionsPackage.Literals.ADD_EXPRESSION__LEFT ||
			childFeature == ExpressionsPackage.Literals.ADD_EXPRESSION__RIGHT;
