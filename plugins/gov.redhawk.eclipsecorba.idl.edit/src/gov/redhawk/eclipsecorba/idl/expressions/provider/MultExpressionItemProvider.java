...
/**
 * This is the item provider adapter for a {@link gov.redhawk.eclipsecorba.idl.expressions.MultExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MultExpressionItemProvider
	 ...
	 * @generated
	 */
	public MultExpressionItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MultExpression_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MultExpression_type_feature", "_UI_MultExpression_type"),
				 ExpressionsPackage.Literals.MULT_EXPRESSION__TYPE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ExpressionsPackage.Literals.MULT_EXPRESSION__LEFT);
			childrenFeatures.add(ExpressionsPackage.Literals.MULT_EXPRESSION__RIGHT);
		}
	...
	/**
	 * This returns MultExpression.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MultExpression"));
	}
	...
	public String getText(Object object) {
		MultExpression multExpression = (MultExpression)object;

		Expression left = multExpression.getLeft();
		Expression right = multExpression.getRight();
		...
		return leftLp.getText(left) + multExpression.getType().getLiteral() + rightLp.getText(right);
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MultExpression.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ExpressionsPackage.Literals.MULT_EXPRESSION__LEFT,
		...
		newChildDescriptors.add
			(createChildParameter
				(ExpressionsPackage.Literals.MULT_EXPRESSION__RIGHT,
				 ExpressionsFactory.eINSTANCE.createConstExpression()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == ExpressionsPackage.Literals.MULT_EXPRESSION__LEFT ||
			childFeature == ExpressionsPackage.Literals.MULT_EXPRESSION__RIGHT;
