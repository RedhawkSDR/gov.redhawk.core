...
/**
 * This is the item provider adapter for a {@link gov.redhawk.eclipsecorba.idl.expressions.IntegerLiteral} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IntegerLiteralItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ExpressionsPackage.Literals.INTEGER_LITERAL__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return Integer.valueOf(integerLiteral.getValue()).toString();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(IntegerLiteral.class)) {
			case ExpressionsPackage.INTEGER_LITERAL__VALUE:
