...
public abstract class dataXMLPOA extends omnijni.Servant implements BULKIO.dataXMLOperations
{
  public dataXMLPOA ()
  {
  }
  ...
  {
    this._activate();
    long ref = dataXMLPOA.new_reference(this.servant_);
    BULKIO.jni._dataXMLStub stub = new BULKIO.jni._dataXMLStub(ref);
  ...
  {
    if (this.servant_ == 0) {
      this.servant_ = dataXMLPOA.new_servant();
  ...
  {
    if (this.servant_ != 0) {
      dataXMLPOA.del_servant(this.servant_);
      this.servant_ = 0;
    }
  }
  ...
  private static native void set_delegate (long servant, BULKIO.dataXMLOperations delegate);
