...
public abstract class dataShortPOA extends omnijni.Servant implements BULKIO.dataShortOperations
{
  public dataShortPOA ()
  {
  }
  ...
  {
    this._activate();
    long ref = dataShortPOA.new_reference(this.servant_);
    BULKIO.jni._dataShortStub stub = new BULKIO.jni._dataShortStub(ref);
  ...
  {
    if (this.servant_ == 0) {
      this.servant_ = dataShortPOA.new_servant();
  ...
  {
    if (this.servant_ != 0) {
      dataShortPOA.del_servant(this.servant_);
      this.servant_ = 0;
    }
  }
  ...
  private static native void set_delegate (long servant, BULKIO.dataShortOperations delegate);
