...
public class _dataDoubleStub extends omnijni.ObjectImpl implements BULKIO.dataDouble
{
  public _dataDoubleStub ()
  {
  }

  protected _dataDoubleStub (long ref)
  {
    super(ref);
  }
  ...
  public void pushPacket (double[] data, BULKIO.PrecisionUTCTime T, boolean EOS, String streamID)
  {
    pushPacket(this.ref_, data, T, EOS, streamID);
  }
  private static native void pushPacket (long __ref__, double[] data, BULKIO.PrecisionUTCTime T, boolean EOS, String streamID);

  private static String __ids[] = {
    "IDL:BULKIO/dataDouble:1.0",
