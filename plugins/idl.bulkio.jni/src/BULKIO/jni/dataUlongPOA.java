...
public abstract class dataUlongPOA extends omnijni.Servant implements BULKIO.dataUlongOperations
{
  public dataUlongPOA ()
  {
  }
  ...
  {
    this._activate();
    long ref = dataUlongPOA.new_reference(this.servant_);
    BULKIO.jni._dataUlongStub stub = new BULKIO.jni._dataUlongStub(ref);
  ...
  {
    if (this.servant_ == 0) {
      this.servant_ = dataUlongPOA.new_servant();
  ...
  {
    if (this.servant_ != 0) {
      dataUlongPOA.del_servant(this.servant_);
      this.servant_ = 0;
    }
  }
  ...
  private static native void set_delegate (long servant, BULKIO.dataUlongOperations delegate);
