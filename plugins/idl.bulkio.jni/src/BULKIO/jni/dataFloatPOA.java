...
public abstract class dataFloatPOA extends omnijni.Servant implements BULKIO.dataFloatOperations
{
  public dataFloatPOA ()
  {
  }
  ...
  {
    this._activate();
    long ref = dataFloatPOA.new_reference(this.servant_);
    BULKIO.jni._dataFloatStub stub = new BULKIO.jni._dataFloatStub(ref);
  ...
  {
    if (this.servant_ == 0) {
      this.servant_ = dataFloatPOA.new_servant();
  ...
  {
    if (this.servant_ != 0) {
      dataFloatPOA.del_servant(this.servant_);
      this.servant_ = 0;
    }
  }
  ...
  private static native void set_delegate (long servant, BULKIO.dataFloatOperations delegate);
