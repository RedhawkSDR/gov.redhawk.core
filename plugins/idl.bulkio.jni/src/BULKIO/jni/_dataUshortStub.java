...
public class _dataUshortStub extends omnijni.ObjectImpl implements BULKIO.dataUshort
{
  public _dataUshortStub ()
  {
  }

  protected _dataUshortStub (long ref)
  {
    super(ref);
  }
  ...
  public void pushPacket (short[] data, BULKIO.PrecisionUTCTime T, boolean EOS, String streamID)
  {
    pushPacket(this.ref_, data, T, EOS, streamID);
  }
  private static native void pushPacket (long __ref__, short[] data, BULKIO.PrecisionUTCTime T, boolean EOS, String streamID);

  private static String __ids[] = {
    "IDL:BULKIO/dataUshort:1.0",
