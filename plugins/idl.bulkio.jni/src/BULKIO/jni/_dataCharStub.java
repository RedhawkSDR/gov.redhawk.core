...
public class _dataCharStub extends omnijni.ObjectImpl implements BULKIO.dataChar
{
  public _dataCharStub ()
  {
  }

  protected _dataCharStub (long ref)
  {
    super(ref);
  }
  ...
  public void pushPacket (char[] data, BULKIO.PrecisionUTCTime T, boolean EOS, String streamID)
  {
    pushPacket(this.ref_, data, T, EOS, streamID);
  }
  private static native void pushPacket (long __ref__, char[] data, BULKIO.PrecisionUTCTime T, boolean EOS, String streamID);

  private static String __ids[] = {
    "IDL:BULKIO/dataChar:1.0",
