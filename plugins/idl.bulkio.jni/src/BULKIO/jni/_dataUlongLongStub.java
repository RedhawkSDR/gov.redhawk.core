...
public class _dataUlongLongStub extends omnijni.ObjectImpl implements BULKIO.dataUlongLong
{
  public _dataUlongLongStub ()
  {
  }

  protected _dataUlongLongStub (long ref)
  {
    super(ref);
  }
  ...
  public void pushPacket (long[] data, BULKIO.PrecisionUTCTime T, boolean EOS, String streamID)
  {
    pushPacket(this.ref_, data, T, EOS, streamID);
  }
  private static native void pushPacket (long __ref__, long[] data, BULKIO.PrecisionUTCTime T, boolean EOS, String streamID);

  private static String __ids[] = {
    "IDL:BULKIO/dataUlongLong:1.0",
