...
public class _dataBitStub extends omnijni.ObjectImpl implements BULKIO.dataBit
{
  public _dataBitStub ()
  {
  }

  protected _dataBitStub (long ref)
  {
    super(ref);
  }
  ...
  private static native void pushPacket (long __ref__, BULKIO.BitSequence data, BULKIO.PrecisionUTCTime T, boolean EOS, String streamID);

  private static String __ids[] = {
    "IDL:BULKIO/dataBit:1.0",
