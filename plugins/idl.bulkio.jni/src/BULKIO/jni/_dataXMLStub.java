...
public class _dataXMLStub extends omnijni.ObjectImpl implements BULKIO.dataXML
{
  public _dataXMLStub ()
  {
  }

  protected _dataXMLStub (long ref)
  {
    super(ref);
  }
  ...
  public void pushPacket (String xml_string, boolean EOS, String streamID)
  {
    pushPacket(this.ref_, xml_string, EOS, streamID);
  }
  private static native void pushPacket (long __ref__, String xml_string, boolean EOS, String streamID);

  private static String __ids[] = {
    "IDL:BULKIO/dataXML:1.0",
