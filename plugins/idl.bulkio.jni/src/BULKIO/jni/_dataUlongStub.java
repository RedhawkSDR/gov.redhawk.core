...
public class _dataUlongStub extends omnijni.ObjectImpl implements BULKIO.dataUlong
{
  public _dataUlongStub ()
  {
  }

  protected _dataUlongStub (long ref)
  {
    super(ref);
  }
  ...
  public void pushPacket (int[] data, BULKIO.PrecisionUTCTime T, boolean EOS, String streamID)
  {
    pushPacket(this.ref_, data, T, EOS, streamID);
  }
  private static native void pushPacket (long __ref__, int[] data, BULKIO.PrecisionUTCTime T, boolean EOS, String streamID);

  private static String __ids[] = {
    "IDL:BULKIO/dataUlong:1.0",
