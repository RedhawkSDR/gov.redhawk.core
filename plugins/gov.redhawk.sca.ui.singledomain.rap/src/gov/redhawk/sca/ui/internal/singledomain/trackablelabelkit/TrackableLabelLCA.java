 ...
 *
 */
package gov.redhawk.sca.ui.internal.singledomain.trackablelabelkit;
...
public class TrackableLabelLCA extends AbstractWidgetLCA {
	...
	public void readData(Widget widget) {
		TrackableLabel control = (TrackableLabel) widget;
	...
	public void renderInitialization(Widget widget) throws IOException {
		...
		writer.newWidget("gov.redhawk.sca.ui.singledomain.TrackableLabel", new Object[] {id});
	...
	public void renderChanges(Widget widget) throws IOException {
		...
		if (mouseEnter != null) {
			writer.set(PARAM_MOUSE_ENTER, PARAM_MOUSE_ENTER, control.getMouseEnter());
		}
