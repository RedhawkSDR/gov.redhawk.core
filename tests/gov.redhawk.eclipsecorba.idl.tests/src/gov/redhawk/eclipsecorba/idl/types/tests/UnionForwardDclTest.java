 ...
 * <em><b>Union Forward Dcl</b></em>'. <!-- end-user-doc -->
 * @generated
 */
public class UnionForwardDclTest extends IdlTypeDclTest {
	...
	public static void main(String[] args) {
		TestRunner.run(UnionForwardDclTest.class);
	}

	/**
	 * Constructs a new Union Forward Dcl test case with the given name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public UnionForwardDclTest(String name) {
		super(name);
	}

	/**
	 * Returns the fixture for this Union Forward Dcl test case.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	@Override
	protected UnionForwardDcl getFixture() {
		return (UnionForwardDcl)fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture(TypesFactory.eINSTANCE.createUnionForwardDcl());
	}
